...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.263.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.263.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lDuhMLlZc5ICkegRCjP5QRQo87AkEi8h/xGR6P1SSSIOFxHwHgTUqUcawpXuXBa2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.263.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.263.0/index.min.mjs": "sha384-lDuhMLlZc5ICkegRCjP5QRQo87AkEi8h/xGR6P1SSSIOFxHwHgTUqUcawpXuXBa2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.263.0/LICENSE
```

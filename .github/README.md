...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qiVs2r3A+gN5vl3090GMVh3jDjFIzcesjZtGhkzyHe96T8AWDFNs4+x7Nok0ea7/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.35.0/index.min.mjs": "sha384-qiVs2r3A+gN5vl3090GMVh3jDjFIzcesjZtGhkzyHe96T8AWDFNs4+x7Nok0ea7/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.35.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpdeDemozlnRz/XxR6rSCJ0QTKpwxC5FGZLTsU9YvkwcuY1sfyGerUP0idU+CjMx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.787.0/index.min.mjs": "sha384-bpdeDemozlnRz/XxR6rSCJ0QTKpwxC5FGZLTsU9YvkwcuY1sfyGerUP0idU+CjMx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.787.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Pqc8iF9J6BPgPE+AG2WoPRFLojWpldXEKWPiFWSIMhaCu3B3rjD3zjiPyFq6hmh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.327.0/index.min.mjs": "sha384-1Pqc8iF9J6BPgPE+AG2WoPRFLojWpldXEKWPiFWSIMhaCu3B3rjD3zjiPyFq6hmh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.327.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kYBAjUp30H485CqK69AD/yNrqDUHUsc+SwgYqwQ3EXBgAW/VdAtl+tKVTFmDnCnL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.288.0/index.min.mjs": "sha384-kYBAjUp30H485CqK69AD/yNrqDUHUsc+SwgYqwQ3EXBgAW/VdAtl+tKVTFmDnCnL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.288.0/LICENSE
```

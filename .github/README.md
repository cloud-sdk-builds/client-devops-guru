...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J+y71CNgu0c8sRRzMbUALleRSAXFkGl2UlqfTl7LyKMJ0UHDQhjOke3Lim5JB2i7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.21.0/index.min.mjs": "sha384-J+y71CNgu0c8sRRzMbUALleRSAXFkGl2UlqfTl7LyKMJ0UHDQhjOke3Lim5JB2i7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-vh4mvPET/0DvSNQC2WmBGaH5jUSHOy7m6Ufi7iHqFdELFrGjZHj9wXletCdyqwPU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.1/index.min.mjs": "sha384-vh4mvPET/0DvSNQC2WmBGaH5jUSHOy7m6Ufi7iHqFdELFrGjZHj9wXletCdyqwPU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.54.1/LICENSE
```

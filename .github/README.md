...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X/NRiM6ORcMBdzs2FeC40dVyJm82tINxwxvG6RE90hw1l3P7wGgkUenrV3QbqK1N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.169.0/index.min.mjs": "sha384-X/NRiM6ORcMBdzs2FeC40dVyJm82tINxwxvG6RE90hw1l3P7wGgkUenrV3QbqK1N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.169.0/LICENSE
```

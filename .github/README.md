...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LRDiu7PRCIPd+UnyYpHjHC9+RFdaXawo/6uOU4XoQIbHRSMxOstVgIaptMBvY3uB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.991.0/index.min.mjs": "sha384-LRDiu7PRCIPd+UnyYpHjHC9+RFdaXawo/6uOU4XoQIbHRSMxOstVgIaptMBvY3uB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.991.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lm5jFI79FhDKTkuq4Mi6dmnAxg5rUk8DEBKLWJY1ApSG13xEA5BTxJpepLFdXMj9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.421.0/index.min.mjs": "sha384-Lm5jFI79FhDKTkuq4Mi6dmnAxg5rUk8DEBKLWJY1ApSG13xEA5BTxJpepLFdXMj9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.421.0/LICENSE
```

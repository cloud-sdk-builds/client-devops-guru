...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GFCAyKAkC7J5SrtIz5g1+il3LhaBGX8FNcvO2B5HKs7+JB2mR399oF1UeST8HhQK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.460.0/index.min.mjs": "sha384-GFCAyKAkC7J5SrtIz5g1+il3LhaBGX8FNcvO2B5HKs7+JB2mR399oF1UeST8HhQK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.460.0/LICENSE
```

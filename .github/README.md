...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-So1/Y+u3XC2hKYZ6QxhCt/1tQhQ+C/7O3tTn6iaLpQ3ySVZJO8IEx8bAIIqPazaf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.425.0/index.min.mjs": "sha384-So1/Y+u3XC2hKYZ6QxhCt/1tQhQ+C/7O3tTn6iaLpQ3ySVZJO8IEx8bAIIqPazaf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.425.0/LICENSE
```

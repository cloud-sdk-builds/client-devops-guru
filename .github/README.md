...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eyveFN4b7BcD1a9w8r2x9T5IwnhaNmCr7/O0SEBnt9k1Qrs7OltNPFGI+xuZ1zpI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.357.0/index.min.mjs": "sha384-eyveFN4b7BcD1a9w8r2x9T5IwnhaNmCr7/O0SEBnt9k1Qrs7OltNPFGI+xuZ1zpI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.357.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wr2Fp1r7e0NinNT1CqX+mwY+aBQFecUfGC3wsXJ/iglM6IFMi8+VNQQeP0iAhrIm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.458.0/index.min.mjs": "sha384-Wr2Fp1r7e0NinNT1CqX+mwY+aBQFecUfGC3wsXJ/iglM6IFMi8+VNQQeP0iAhrIm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.458.0/LICENSE
```

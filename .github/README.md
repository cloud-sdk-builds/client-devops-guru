...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nVXk/FNj0F9Fx6ovW7ABsO6p+mgalbr+hL5DP7WIX8UWRmEUBaG2Af6X0Ih/jG3Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.11.0/index.min.mjs": "sha384-nVXk/FNj0F9Fx6ovW7ABsO6p+mgalbr+hL5DP7WIX8UWRmEUBaG2Af6X0Ih/jG3Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.11.0/LICENSE
```

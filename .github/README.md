...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2yaxZgHU0zwNhhyJ2DpuA0sgXjBxEq7iJIks+YoTIhLq/1eIjDkH+MyFwmkuv7fb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.936.0/index.min.mjs": "sha384-2yaxZgHU0zwNhhyJ2DpuA0sgXjBxEq7iJIks+YoTIhLq/1eIjDkH+MyFwmkuv7fb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.936.0/LICENSE
```

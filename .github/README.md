...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AKCDuxZEc2GrZsNOC+0SaoJ0SIAZ9nPRfcLfr0R/kYdLPrN3zkkMA1V7Gn18N2SQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.296.0/index.min.mjs": "sha384-AKCDuxZEc2GrZsNOC+0SaoJ0SIAZ9nPRfcLfr0R/kYdLPrN3zkkMA1V7Gn18N2SQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.296.0/LICENSE
```

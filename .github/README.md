...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yPUgsqclTWueuGsXdkOAh2gvmqXw4316xkfbjLeSfg3ri9EpGs7bG3kfS3g4cvRI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.428.0/index.min.mjs": "sha384-yPUgsqclTWueuGsXdkOAh2gvmqXw4316xkfbjLeSfg3ri9EpGs7bG3kfS3g4cvRI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.428.0/LICENSE
```

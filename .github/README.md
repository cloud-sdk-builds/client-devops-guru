...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5reEZqP2SRmqvPyixbMmDDtSfcqRfML7XF7dL9HruZDu0HBixGK2h1BSgtu6cTxt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.509.0/index.min.mjs": "sha384-5reEZqP2SRmqvPyixbMmDDtSfcqRfML7XF7dL9HruZDu0HBixGK2h1BSgtu6cTxt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.509.0/LICENSE
```

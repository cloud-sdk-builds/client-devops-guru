...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9iGqUYV7ZMR5BZgXz6YIN2mSZO1IxQKb5ji+NIin/QN78eoeeBuM7AR/bPg8khd9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.911.0/index.min.mjs": "sha384-9iGqUYV7ZMR5BZgXz6YIN2mSZO1IxQKb5ji+NIin/QN78eoeeBuM7AR/bPg8khd9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.911.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MOrx5cRN/q8REqWlU3bNO8ae/r80Ox0niVEWpuydqYOY2t+iL957hg0fsVoPzGxc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.2.0/index.min.mjs": "sha384-MOrx5cRN/q8REqWlU3bNO8ae/r80Ox0niVEWpuydqYOY2t+iL957hg0fsVoPzGxc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.2.0/LICENSE
```

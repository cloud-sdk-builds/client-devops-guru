...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1zhN6GNU0LsB+zEbknWkfVnNi7DFVUfNjRRL1y5YTzWeTJvqpK4FS9qfdInStC7r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.185.0/index.min.mjs": "sha384-1zhN6GNU0LsB+zEbknWkfVnNi7DFVUfNjRRL1y5YTzWeTJvqpK4FS9qfdInStC7r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.185.0/LICENSE
```

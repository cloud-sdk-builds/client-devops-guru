...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l8J46ur3AF6lbfCsM9ofnstCvZvW8Z2RZiPuplVGnmADE7wDg5ipJaXfZZcs0HVN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.359.0/index.min.mjs": "sha384-l8J46ur3AF6lbfCsM9ofnstCvZvW8Z2RZiPuplVGnmADE7wDg5ipJaXfZZcs0HVN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.359.0/LICENSE
```

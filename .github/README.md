...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ik+8SeGiomy+gG65gMbL9Ml6v9AnEb8kJiULWulbZoqgB546pQvsxcCyDBAOxuXv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.79.0/index.min.mjs": "sha384-ik+8SeGiomy+gG65gMbL9Ml6v9AnEb8kJiULWulbZoqgB546pQvsxcCyDBAOxuXv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.79.0/LICENSE
```

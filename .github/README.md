...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AXBJnCMaEttEqyCWBCP3div5RQA5/F0sIOJ5ZkRuyLeu1aUaTb2fCrshrpmlG8yJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.441.0/index.min.mjs": "sha384-AXBJnCMaEttEqyCWBCP3div5RQA5/F0sIOJ5ZkRuyLeu1aUaTb2fCrshrpmlG8yJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.441.0/LICENSE
```

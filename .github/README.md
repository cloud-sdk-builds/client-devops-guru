...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TtkEpGW+JYPE6Bm8DxeFGTS5f2XPv7wWieySlCs7b1hMkAbRe7T76YJS2Yvxo1Ya
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.130.0/index.min.mjs": "sha384-TtkEpGW+JYPE6Bm8DxeFGTS5f2XPv7wWieySlCs7b1hMkAbRe7T76YJS2Yvxo1Ya"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.130.0/LICENSE
```

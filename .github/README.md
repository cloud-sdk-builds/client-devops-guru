...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MQebHXQYzqbveSS2B3AU4e5ESV868hS6WIclUIJjqWHNXYUAru3IZySFoNaAFnoJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.798.0/index.min.mjs": "sha384-MQebHXQYzqbveSS2B3AU4e5ESV868hS6WIclUIJjqWHNXYUAru3IZySFoNaAFnoJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.798.0/LICENSE
```

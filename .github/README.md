...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EC7H6CfceoZd7kyBTgWliT5at2fcpbCfl9QjvNOt3pknVRzI+n7KrENVZv+bRmeB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.150.0/index.min.mjs": "sha384-EC7H6CfceoZd7kyBTgWliT5at2fcpbCfl9QjvNOt3pknVRzI+n7KrENVZv+bRmeB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.150.0/LICENSE
```

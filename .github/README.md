...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.608.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.608.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e+X/v2Gf5Cev+VZhW+ce5wUyMxpyciUTWKLwxHdmW124ioLhTX2sViougy/u9IqB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.608.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.608.0/index.min.mjs": "sha384-e+X/v2Gf5Cev+VZhW+ce5wUyMxpyciUTWKLwxHdmW124ioLhTX2sViougy/u9IqB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.608.0/LICENSE
```

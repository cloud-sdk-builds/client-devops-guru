...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+S0pAIsTM7MdDAfO+JO2M+zntDyHrjpT6OYph1Dm6/DiEIk/0/qREalGUzYsfFYZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1036.0/index.min.mjs": "sha384-+S0pAIsTM7MdDAfO+JO2M+zntDyHrjpT6OYph1Dm6/DiEIk/0/qREalGUzYsfFYZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1036.0/LICENSE
```

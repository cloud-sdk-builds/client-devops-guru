...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EI6FD7LjwcOdZdiaZs4kHGI5c3874HJQT8TinE8TLrgydu3OikdzOyp7lozLogbn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.596.0/index.min.mjs": "sha384-EI6FD7LjwcOdZdiaZs4kHGI5c3874HJQT8TinE8TLrgydu3OikdzOyp7lozLogbn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.596.0/LICENSE
```

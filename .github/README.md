...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FWbhi77MFkcfIidASWsHCNGt6kf4CXSOGuxl+IusNuqdCFyvH5et+DOW4Crjr8IY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.204.0/index.min.mjs": "sha384-FWbhi77MFkcfIidASWsHCNGt6kf4CXSOGuxl+IusNuqdCFyvH5et+DOW4Crjr8IY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.204.0/LICENSE
```

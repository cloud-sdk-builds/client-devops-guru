...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qSlXLGZYC8YEmgdN/rMOfoHz8CrX5IXNP5+53xwuwCKbLX59P9nV/QFQ/BK8jxDO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.582.0/index.min.mjs": "sha384-qSlXLGZYC8YEmgdN/rMOfoHz8CrX5IXNP5+53xwuwCKbLX59P9nV/QFQ/BK8jxDO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.582.0/LICENSE
```

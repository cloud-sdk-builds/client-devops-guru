...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BwdtnErkUiZw5Rkt0uM/bwj4SDU507qeytlWjLYP1eKnJOzbGzouEz9374qz7wNQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.42.0/index.min.mjs": "sha384-BwdtnErkUiZw5Rkt0uM/bwj4SDU507qeytlWjLYP1eKnJOzbGzouEz9374qz7wNQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.42.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hMrWWUk6NiDVuQFEq3NDXEpUATy7BGxHhVQcfWk9igYxOUy9vvndvRmta3S7DHNg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.995.0/index.min.mjs": "sha384-hMrWWUk6NiDVuQFEq3NDXEpUATy7BGxHhVQcfWk9igYxOUy9vvndvRmta3S7DHNg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.995.0/LICENSE
```

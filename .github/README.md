...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yn8jh4+LZ4fRoQojO0UJDgzxsehG+80+9yP1ge61ct0xVOQ2gksBg/6EsZqD9noQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.477.0/index.min.mjs": "sha384-yn8jh4+LZ4fRoQojO0UJDgzxsehG+80+9yP1ge61ct0xVOQ2gksBg/6EsZqD9noQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.477.0/LICENSE
```

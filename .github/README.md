...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q1zG6eRRzoeU45EWqS9v4/cWwaPfixDr3JD2McPt+8DOsiyY9QI4XafgVjU5llGO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.100.0/index.min.mjs": "sha384-q1zG6eRRzoeU45EWqS9v4/cWwaPfixDr3JD2McPt+8DOsiyY9QI4XafgVjU5llGO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.100.0/LICENSE
```

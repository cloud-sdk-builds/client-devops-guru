...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QYHhgaHdsbpg5DL+H5O83mjGCw3syfTM9muXrBr5dxzlxbR5AdC+dRbG2YJr3b3s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.0.0/index.min.mjs": "sha384-QYHhgaHdsbpg5DL+H5O83mjGCw3syfTM9muXrBr5dxzlxbR5AdC+dRbG2YJr3b3s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.0.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MKba+w6qeqe3DMdzGN5saJoCH9xzoTQsmInt9GOpKefdxb0dWPJzEZ6/zib5E0rP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.112.0/index.min.mjs": "sha384-MKba+w6qeqe3DMdzGN5saJoCH9xzoTQsmInt9GOpKefdxb0dWPJzEZ6/zib5E0rP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.112.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qoqYZL/p9qXl3zSBjy1Vl5PZGhQeA0m0sM/h2bNxPtneILkgvxT1B5fhmQZwjkvA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.292.0/index.min.mjs": "sha384-qoqYZL/p9qXl3zSBjy1Vl5PZGhQeA0m0sM/h2bNxPtneILkgvxT1B5fhmQZwjkvA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.292.0/LICENSE
```

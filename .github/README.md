...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/B4huZMJVAQCjEnNz+s04xaFGXWJOddyfK2GYdFoMhKGZmo10INujunxPysDsDZr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.692.0/index.min.mjs": "sha384-/B4huZMJVAQCjEnNz+s04xaFGXWJOddyfK2GYdFoMhKGZmo10INujunxPysDsDZr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.692.0/LICENSE
```

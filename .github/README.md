...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rYVzmCqLI3V7QOpNGjecDcrFXEKRwZeV997KHWa+5X6ZI+JVZV34bwJTKMca9Cin
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.414.0/index.min.mjs": "sha384-rYVzmCqLI3V7QOpNGjecDcrFXEKRwZeV997KHWa+5X6ZI+JVZV34bwJTKMca9Cin"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.414.0/LICENSE
```

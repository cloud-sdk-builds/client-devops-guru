...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7LI4jo+KT/ecMD5NCTnXlqjQ3tnzlx7MvO6omunslf7XN5O3ARhxr1iI1g5YZ5la
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.848.0/index.min.mjs": "sha384-7LI4jo+KT/ecMD5NCTnXlqjQ3tnzlx7MvO6omunslf7XN5O3ARhxr1iI1g5YZ5la"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.848.0/LICENSE
```

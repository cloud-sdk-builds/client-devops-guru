...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PT0Qp3EEZGk55ocspn1g2TyAQ82Gm4S2jlMFIcVDn7bP/pH2MaOzxzcMgvfKlSNP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.82.0/index.min.mjs": "sha384-PT0Qp3EEZGk55ocspn1g2TyAQ82Gm4S2jlMFIcVDn7bP/pH2MaOzxzcMgvfKlSNP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.82.0/LICENSE
```

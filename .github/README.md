...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eM5pUwjYV17D5O+uJLZbY2oU1LoUzIiOrTbvruCmV3ElfQfHHURIrTrqK3i6NzQ+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.989.0/index.min.mjs": "sha384-eM5pUwjYV17D5O+uJLZbY2oU1LoUzIiOrTbvruCmV3ElfQfHHURIrTrqK3i6NzQ+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.989.0/LICENSE
```

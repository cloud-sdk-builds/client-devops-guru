...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yD3wqkqJ9TjqoEQIRtn/rR+t7TZxXbUHwJX3oNXBeB7EkU32SEKe1ZNell3JL915
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.968.0/index.min.mjs": "sha384-yD3wqkqJ9TjqoEQIRtn/rR+t7TZxXbUHwJX3oNXBeB7EkU32SEKe1ZNell3JL915"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.968.0/LICENSE
```

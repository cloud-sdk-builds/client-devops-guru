...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cqPR5O/7n4uRWu9dqiAopASwlzv90tytfjlmZ1boyi+QegqomJ5aV/nPZ2JUmoxT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.43.0/index.min.mjs": "sha384-cqPR5O/7n4uRWu9dqiAopASwlzv90tytfjlmZ1boyi+QegqomJ5aV/nPZ2JUmoxT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.43.0/LICENSE
```

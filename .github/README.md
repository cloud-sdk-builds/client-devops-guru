...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oORsuYVxHWznlhSQa6YsSGosqdbWiBDwQJeK4wJX6Z6MP2qB831/GCTiSu1lv48G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.53.0/index.min.mjs": "sha384-oORsuYVxHWznlhSQa6YsSGosqdbWiBDwQJeK4wJX6Z6MP2qB831/GCTiSu1lv48G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.53.0/LICENSE
```

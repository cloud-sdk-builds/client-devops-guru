...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sXZaznyT3HFrU62quTrvnpljCGau+wguC7wfm8Lkw0e6+Wc8+fyhkmiKzXPO6FkP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.370.0/index.min.mjs": "sha384-sXZaznyT3HFrU62quTrvnpljCGau+wguC7wfm8Lkw0e6+Wc8+fyhkmiKzXPO6FkP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.370.0/LICENSE
```

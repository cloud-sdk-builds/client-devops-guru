...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-llOqn5zxc0PZ0UJI82u+8kx3BdkdQsdhueATYxpKUboh3ioRc/GFmVLQSL9yYmHK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.948.0/index.min.mjs": "sha384-llOqn5zxc0PZ0UJI82u+8kx3BdkdQsdhueATYxpKUboh3ioRc/GFmVLQSL9yYmHK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.948.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SYjr13axhQJNzihHy0pHnPnQJ3RQ5K15Vr+BbhBD9CAfaDwl+moh07EdxRIHMg0M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.194.0/index.min.mjs": "sha384-SYjr13axhQJNzihHy0pHnPnQJ3RQ5K15Vr+BbhBD9CAfaDwl+moh07EdxRIHMg0M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.194.0/LICENSE
```

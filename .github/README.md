...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e2qb2u/YxMsQ0VDai1aoevHxbicGEARNzoQmqGNXXR3oFgcj2yOkg9/cy9zts9bE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.300.0/index.min.mjs": "sha384-e2qb2u/YxMsQ0VDai1aoevHxbicGEARNzoQmqGNXXR3oFgcj2yOkg9/cy9zts9bE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.300.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-btyi1RfemVrl4eib/6PuGvlqkqxT9bqWhOwlYoGQYtMdXpxLe/j11Z5F49QmaCVC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.1/index.min.mjs": "sha384-btyi1RfemVrl4eib/6PuGvlqkqxT9bqWhOwlYoGQYtMdXpxLe/j11Z5F49QmaCVC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.347.1/LICENSE
```

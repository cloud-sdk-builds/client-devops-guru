...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3PVcDtg/X7EulFrbg2Q2CTBSu8Zg/ttIZqGZ1R2MveqxwwzqrsfaMSAVsqIE7hpq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.198.0/index.min.mjs": "sha384-3PVcDtg/X7EulFrbg2Q2CTBSu8Zg/ttIZqGZ1R2MveqxwwzqrsfaMSAVsqIE7hpq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.198.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uqTAMoo3yXm32tPTWC2W6ULIqvbp0Xsi4npVBLlO6cgalcgNtOWi78jy6syFTiJk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.0/index.min.mjs": "sha384-uqTAMoo3yXm32tPTWC2W6ULIqvbp0Xsi4npVBLlO6cgalcgNtOWi78jy6syFTiJk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.6.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8fWnVAqaj/49QsiBOpIgzIby18EvZcPqvwhl2fzIXzbNUph/Km5o+MjD39MI91wr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.835.0/index.min.mjs": "sha384-8fWnVAqaj/49QsiBOpIgzIby18EvZcPqvwhl2fzIXzbNUph/Km5o+MjD39MI91wr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.835.0/LICENSE
```

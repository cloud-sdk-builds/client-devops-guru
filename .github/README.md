...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R0W6q520RUP/xN2SfU+8TzM95dPwz332Wld/JqOVxwgIRG7mDE56sjPQSyGmGShZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.28.0/index.min.mjs": "sha384-R0W6q520RUP/xN2SfU+8TzM95dPwz332Wld/JqOVxwgIRG7mDE56sjPQSyGmGShZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.28.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rtZdlVKW75FIrx3z3TRWok2qeufY/pqabztjoMdDdtNyS/m8X+I3iTmYXVCHpLUK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.587.0/index.min.mjs": "sha384-rtZdlVKW75FIrx3z3TRWok2qeufY/pqabztjoMdDdtNyS/m8X+I3iTmYXVCHpLUK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.587.0/LICENSE
```

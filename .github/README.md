...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D3AZkmnMMFbNzCL7DuIQCCmZp8cwAT7JJvhhqIH6A+rTZprcfFxq7/ZlxLZLTXoM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.418.0/index.min.mjs": "sha384-D3AZkmnMMFbNzCL7DuIQCCmZp8cwAT7JJvhhqIH6A+rTZprcfFxq7/ZlxLZLTXoM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.418.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-55IgKD2e697zGHX4rroI4COagcTqMeag2xz6fM1vIBBRZ1AtX5weEt+x7VHtoZRy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.716.0/index.min.mjs": "sha384-55IgKD2e697zGHX4rroI4COagcTqMeag2xz6fM1vIBBRZ1AtX5weEt+x7VHtoZRy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.716.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7IH+sw6k8Dl6w5FbU0NoUSVBagaaLBKi51Y3vRD8iHez9UqxKj41SAyYcrH/uDXn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.223.0/index.min.mjs": "sha384-7IH+sw6k8Dl6w5FbU0NoUSVBagaaLBKi51Y3vRD8iHez9UqxKj41SAyYcrH/uDXn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.223.0/LICENSE
```

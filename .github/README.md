...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dP8x42dVOFlXxmJxGoBmb9aBXOZTH+QG1hqwWkAk+qu9AYC5blhORWvxk9E03yEb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.974.0/index.min.mjs": "sha384-dP8x42dVOFlXxmJxGoBmb9aBXOZTH+QG1hqwWkAk+qu9AYC5blhORWvxk9E03yEb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.974.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u2fLnfMv77R5/82DyTqHEUl8u2vyhUfN5NxwMHCYxhlbjPLQS2WsqBE1vzaSyBfA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.839.0/index.min.mjs": "sha384-u2fLnfMv77R5/82DyTqHEUl8u2vyhUfN5NxwMHCYxhlbjPLQS2WsqBE1vzaSyBfA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.839.0/LICENSE
```

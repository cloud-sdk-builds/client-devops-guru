...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQkkm+qCmN+58ZxLwwg7a1WrYW7CSqIjdMmpdwP49RarbDzrLxdXELCAISxcZhZx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.229.0/index.min.mjs": "sha384-LQkkm+qCmN+58ZxLwwg7a1WrYW7CSqIjdMmpdwP49RarbDzrLxdXELCAISxcZhZx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.229.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ogG2d9mqSaZGxR5xB1hfMHe1EPaCP5AeOSmuvVu0X0yT2W6/N7zz7b28Cx0Hrgh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.845.0/index.min.mjs": "sha384-+ogG2d9mqSaZGxR5xB1hfMHe1EPaCP5AeOSmuvVu0X0yT2W6/N7zz7b28Cx0Hrgh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.845.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TpbPLP3Zvb9u4XG6t9Y0tDIV2I3mMBgO2X4ZMCwzcuaZmoR/JIxdcj4kT7R2YgSB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.31.0/index.min.mjs": "sha384-TpbPLP3Zvb9u4XG6t9Y0tDIV2I3mMBgO2X4ZMCwzcuaZmoR/JIxdcj4kT7R2YgSB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.31.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5nVl3VS9gn55Hjr53vZIZ+qz0zlhYm79AXj3hiVStgw7V48IRyUbSA8qHvALzi+N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.92.0/index.min.mjs": "sha384-5nVl3VS9gn55Hjr53vZIZ+qz0zlhYm79AXj3hiVStgw7V48IRyUbSA8qHvALzi+N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.92.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A6SWWNCVT6zm/QC1iNGb8K0tgtCJ48gKnj6zNZViEIOxm/Q16gAsMKMTq4WPzo1A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.495.0/index.min.mjs": "sha384-A6SWWNCVT6zm/QC1iNGb8K0tgtCJ48gKnj6zNZViEIOxm/Q16gAsMKMTq4WPzo1A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.495.0/LICENSE
```

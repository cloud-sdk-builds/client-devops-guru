...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vJpvhSBRkLpDXXDBDe756hdQm50u8cKYRYIux0xPhndb9Y91YP9z/X1Tinbh2OZl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.552.0/index.min.mjs": "sha384-vJpvhSBRkLpDXXDBDe756hdQm50u8cKYRYIux0xPhndb9Y91YP9z/X1Tinbh2OZl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.552.0/LICENSE
```

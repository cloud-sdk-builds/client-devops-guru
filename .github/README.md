...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CBZMCQne3bSo0XujSrihm3DcspZJMX81qM4QY2HoygWEyJx0twMW2bqEEuguGE0t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.470.0/index.min.mjs": "sha384-CBZMCQne3bSo0XujSrihm3DcspZJMX81qM4QY2HoygWEyJx0twMW2bqEEuguGE0t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.470.0/LICENSE
```

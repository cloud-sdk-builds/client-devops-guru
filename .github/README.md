...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hvrBWhH9bClJs7ps3hek1EiRSaG+birIgTTuCRCGCLihWy7k7GPmRryZ0pfl5oyz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.258.0/index.min.mjs": "sha384-hvrBWhH9bClJs7ps3hek1EiRSaG+birIgTTuCRCGCLihWy7k7GPmRryZ0pfl5oyz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.258.0/LICENSE
```

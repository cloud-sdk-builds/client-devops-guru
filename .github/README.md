...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jDC6/C1vt+9FNb+l8IbU1uu9KHc++DfBabgRVfEkQjDbaP8ZKHkF4mwpRwNaTapn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.58.0/index.min.mjs": "sha384-jDC6/C1vt+9FNb+l8IbU1uu9KHc++DfBabgRVfEkQjDbaP8ZKHkF4mwpRwNaTapn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.58.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KMc1IuXn6JdcXlX0MbCgoaodRn3GDLTbM+6rYY4HaqVLD2djGMsw5NlZ4GePru1n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.87.0/index.min.mjs": "sha384-KMc1IuXn6JdcXlX0MbCgoaodRn3GDLTbM+6rYY4HaqVLD2djGMsw5NlZ4GePru1n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.87.0/LICENSE
```

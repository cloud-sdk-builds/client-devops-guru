...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kT7XP4TgY7XfWWJRJy6B+UhUox025Bqp8x12CXGcQOtRd6nCrqLD3bJ0YLlfb9z9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.665.0/index.min.mjs": "sha384-kT7XP4TgY7XfWWJRJy6B+UhUox025Bqp8x12CXGcQOtRd6nCrqLD3bJ0YLlfb9z9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.665.0/LICENSE
```

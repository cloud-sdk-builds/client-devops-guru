...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Eqm4rFeNTPP58YYZ9bub4iw7TEBjV2k5l4damqWpcsBhJKuG5Agk6UcD2C6JtHqO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.192.0/index.min.mjs": "sha384-Eqm4rFeNTPP58YYZ9bub4iw7TEBjV2k5l4damqWpcsBhJKuG5Agk6UcD2C6JtHqO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.192.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Po8RxmWjysYDy6SgHxAcsnxoJZggitLrGaV/ar8PwazRjj7tS0stC2V1ikEmTVP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.629.0/index.min.mjs": "sha384-1Po8RxmWjysYDy6SgHxAcsnxoJZggitLrGaV/ar8PwazRjj7tS0stC2V1ikEmTVP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.629.0/LICENSE
```

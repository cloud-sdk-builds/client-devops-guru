...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wYCNJ/mPbEM+nhFhDKs8h6LR6BQdzNeU6te4pfBHH7vlmrgBcFtx/a+o0x/7w1U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.859.0/index.min.mjs": "sha384-9wYCNJ/mPbEM+nhFhDKs8h6LR6BQdzNeU6te4pfBHH7vlmrgBcFtx/a+o0x/7w1U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.859.0/LICENSE
```

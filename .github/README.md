...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rz7u1kVEwVIs/Xc47tP+w+SuuwLIreYAZCOFiyteUReuKshc/5qGtmgxC17p9S5j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.721.0/index.min.mjs": "sha384-rz7u1kVEwVIs/Xc47tP+w+SuuwLIreYAZCOFiyteUReuKshc/5qGtmgxC17p9S5j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.721.0/LICENSE
```

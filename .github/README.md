...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1022.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1022.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qxYu2bDV+NgOXgSx4zi6Azp5H3dn8FaCDkBq4n+TGZkXH2IzRq8cY3cmZIzdVjhg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1022.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1022.0/index.min.mjs": "sha384-qxYu2bDV+NgOXgSx4zi6Azp5H3dn8FaCDkBq4n+TGZkXH2IzRq8cY3cmZIzdVjhg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1022.0/LICENSE
```

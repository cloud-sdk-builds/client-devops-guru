...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I5PHbvczMUa9YE8CBrLZ8HefhZEQOVGx6nvpJLy3IpgcvtRi1u+HFAUK1EeuSdgC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.188.0/index.min.mjs": "sha384-I5PHbvczMUa9YE8CBrLZ8HefhZEQOVGx6nvpJLy3IpgcvtRi1u+HFAUK1EeuSdgC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.188.0/LICENSE
```

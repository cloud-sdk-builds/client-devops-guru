...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-54fb2YIkEfNLNe/CaaO8H3SBcGDizAdS+d2YAsMtzDTBi/3Ukov32QHsDQ+QHizT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.200.0/index.min.mjs": "sha384-54fb2YIkEfNLNe/CaaO8H3SBcGDizAdS+d2YAsMtzDTBi/3Ukov32QHsDQ+QHizT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.200.0/LICENSE
```

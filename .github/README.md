...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1000.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1000.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tacJFHOY/z/z8k1VX/AQFG877TlkBV2mJiu6KWpQmdRTsXA+/yypG9+yuqjyj6/B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1000.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1000.0/index.min.mjs": "sha384-tacJFHOY/z/z8k1VX/AQFG877TlkBV2mJiu6KWpQmdRTsXA+/yypG9+yuqjyj6/B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1000.0/LICENSE
```

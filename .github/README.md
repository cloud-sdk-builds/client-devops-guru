...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9FvVOiPGQY4lAI87LIiVr1JpxkQEr8OSQ9vbOVIBqvc+fB0IG+SJVsbBxVcXZWs3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.345.0/index.min.mjs": "sha384-9FvVOiPGQY4lAI87LIiVr1JpxkQEr8OSQ9vbOVIBqvc+fB0IG+SJVsbBxVcXZWs3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.345.0/LICENSE
```

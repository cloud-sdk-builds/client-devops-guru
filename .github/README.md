...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OZwd3VDJP/Yh6jeSUQuisnFIaBGRh/sq32gjpeP118rV9d4NOA2eGo/LObNcAlcY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.939.0/index.min.mjs": "sha384-OZwd3VDJP/Yh6jeSUQuisnFIaBGRh/sq32gjpeP118rV9d4NOA2eGo/LObNcAlcY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.939.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q/6rEGc18V6+eFtbVpBdfBWb8AvdWK0WhuHUqSUUTRo3PcvPi/OINdV3znDKfPYw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.926.0/index.min.mjs": "sha384-Q/6rEGc18V6+eFtbVpBdfBWb8AvdWK0WhuHUqSUUTRo3PcvPi/OINdV3znDKfPYw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.926.0/LICENSE
```

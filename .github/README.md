...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LwVhWqp76/BbrcdY8VmrjLlehuksEhaVbuHyPy1q5ZaS0NX9m5AO3SmHI+cq57RR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.378.0/index.min.mjs": "sha384-LwVhWqp76/BbrcdY8VmrjLlehuksEhaVbuHyPy1q5ZaS0NX9m5AO3SmHI+cq57RR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.378.0/LICENSE
```

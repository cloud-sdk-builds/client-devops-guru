...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3B8/COoiVQsliJtK0o9+4nZ+jAfNzlwaNXhIX2QzIroYe0Ty1ilZSHrWdFlzy0Zr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.908.0/index.min.mjs": "sha384-3B8/COoiVQsliJtK0o9+4nZ+jAfNzlwaNXhIX2QzIroYe0Ty1ilZSHrWdFlzy0Zr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.908.0/LICENSE
```

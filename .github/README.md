...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-elAXXPYvLm714YhsPtGBnG1OiEYlHQi9o8MCwUYLXUOj/3SxQk4+qOiGzYrqemXX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.201.0/index.min.mjs": "sha384-elAXXPYvLm714YhsPtGBnG1OiEYlHQi9o8MCwUYLXUOj/3SxQk4+qOiGzYrqemXX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.201.0/LICENSE
```

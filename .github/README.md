...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LP1bvowmTLjzMm5VVYwW746ZzGkE1h7+kxswmfEfJbT9dP4YEYS7ZKUur13D5jaq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.514.0/index.min.mjs": "sha384-LP1bvowmTLjzMm5VVYwW746ZzGkE1h7+kxswmfEfJbT9dP4YEYS7ZKUur13D5jaq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.514.0/LICENSE
```

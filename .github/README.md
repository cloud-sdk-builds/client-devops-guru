...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1K5WoyQSv/hXhezZzUtmOeqZj+yrwrJQS6BdSyW2lsvngAhG9wTH6Iq3l/ny5EeR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.224.0/index.min.mjs": "sha384-1K5WoyQSv/hXhezZzUtmOeqZj+yrwrJQS6BdSyW2lsvngAhG9wTH6Iq3l/ny5EeR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.224.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BAQVFoKlGmaup4sMe8fcPFOjV5Sj7EQSafHvIrw2a34tclVTLw4U7OuS7op7J7Tg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.386.0/index.min.mjs": "sha384-BAQVFoKlGmaup4sMe8fcPFOjV5Sj7EQSafHvIrw2a34tclVTLw4U7OuS7op7J7Tg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.386.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nqnIdI4/SHxE6Ot9V0QPtmAEDjgjIb4ICkPI+9U8XqMq0wvVbGT8+kxGdv4Kjjog
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.504.0/index.min.mjs": "sha384-nqnIdI4/SHxE6Ot9V0QPtmAEDjgjIb4ICkPI+9U8XqMq0wvVbGT8+kxGdv4Kjjog"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.504.0/LICENSE
```

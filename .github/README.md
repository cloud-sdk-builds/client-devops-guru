...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k0hLAnBlvNlhwOwXC6BItKf1Cyf+xBX87eaAZqBNN2Nnp3XFVQ+OCOIn6+0EBb/A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.0/index.min.mjs": "sha384-k0hLAnBlvNlhwOwXC6BItKf1Cyf+xBX87eaAZqBNN2Nnp3XFVQ+OCOIn6+0EBb/A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.118.0/LICENSE
```

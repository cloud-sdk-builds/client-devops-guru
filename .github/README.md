...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ItSrg7vS+jbLIge606lG5+wMQ1cPOTQvnkdccSHPYROyv8sW0WuvkqNGTLL35bPl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.398.0/index.min.mjs": "sha384-ItSrg7vS+jbLIge606lG5+wMQ1cPOTQvnkdccSHPYROyv8sW0WuvkqNGTLL35bPl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.398.0/LICENSE
```

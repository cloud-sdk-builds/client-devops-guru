...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XE1MtWgwl0uezJVnTm2HxOxDbmRjoWtFcS54z8AgQrR6b/3OzWT5n9gQBu07GU1O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.95.0/index.min.mjs": "sha384-XE1MtWgwl0uezJVnTm2HxOxDbmRjoWtFcS54z8AgQrR6b/3OzWT5n9gQBu07GU1O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.95.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4mg4W6RXCYI5G9tRgpZcTJuJZ2wVjNRpyDHjCEVbcrDNPg97LBHwFu9Hb6Aucs1Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.858.0/index.min.mjs": "sha384-4mg4W6RXCYI5G9tRgpZcTJuJZ2wVjNRpyDHjCEVbcrDNPg97LBHwFu9Hb6Aucs1Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.858.0/LICENSE
```

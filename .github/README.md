...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bgfe0k0vbhgs9xo72OmkifY7hPxzL2prfRc5NvrIRDDfAW9UhA/v9lv+pHnWqDCW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.986.0/index.min.mjs": "sha384-bgfe0k0vbhgs9xo72OmkifY7hPxzL2prfRc5NvrIRDDfAW9UhA/v9lv+pHnWqDCW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.986.0/LICENSE
```

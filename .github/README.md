...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nsxGrNfZ7+xEMeyXdAuO0lLQrivj4MIq1nmiN7+hPVlDn+ThtQcawJQSe+7juA65
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.445.0/index.min.mjs": "sha384-nsxGrNfZ7+xEMeyXdAuO0lLQrivj4MIq1nmiN7+hPVlDn+ThtQcawJQSe+7juA65"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.445.0/LICENSE
```

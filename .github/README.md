...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LpkP2rtbGzuLZnQMDWFYGSbN4wj1hztErqomvm8fd5UUEjRshAb6pD/uyi/Qtvqu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.39.0/index.min.mjs": "sha384-LpkP2rtbGzuLZnQMDWFYGSbN4wj1hztErqomvm8fd5UUEjRshAb6pD/uyi/Qtvqu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.39.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1gZo5E8eBsqCRsN4Vd9bCOXNuJ0erpflFLxTh7K9G8Dq3VlQf7E2L6mO3eRD3m9A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.930.0/index.min.mjs": "sha384-1gZo5E8eBsqCRsN4Vd9bCOXNuJ0erpflFLxTh7K9G8Dq3VlQf7E2L6mO3eRD3m9A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.930.0/LICENSE
```

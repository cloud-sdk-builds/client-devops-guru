...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oK/V2vdW1+oR9QpLbqDUMA08YMNRv12T59UXFnwnE1Q9o825GQRHx0Blnt5Nqnx5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.127.0/index.min.mjs": "sha384-oK/V2vdW1+oR9QpLbqDUMA08YMNRv12T59UXFnwnE1Q9o825GQRHx0Blnt5Nqnx5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.127.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1CdADM6h2Fk2k8rcpc74GldEyXlnkotWVV06cpKoYkMFh02kTfZe3S4nR1ZIKcu4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.74.0/index.min.mjs": "sha384-1CdADM6h2Fk2k8rcpc74GldEyXlnkotWVV06cpKoYkMFh02kTfZe3S4nR1ZIKcu4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.74.0/LICENSE
```

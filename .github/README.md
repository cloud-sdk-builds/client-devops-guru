...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cSNn4kfNsy7+MYDtZP4+2lWNC469O+tyRYZFGh/e5IaggeFQvL/3qpa/jaQjX08Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.691.0/index.min.mjs": "sha384-cSNn4kfNsy7+MYDtZP4+2lWNC469O+tyRYZFGh/e5IaggeFQvL/3qpa/jaQjX08Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mhnsZQ6hrtct4MT3TRDa7lMxZ0iUIa8V0NE9fa7L8Q2wni4fs3MmFA6rlBiu077p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.222.0/index.min.mjs": "sha384-mhnsZQ6hrtct4MT3TRDa7lMxZ0iUIa8V0NE9fa7L8Q2wni4fs3MmFA6rlBiu077p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.222.0/LICENSE
```

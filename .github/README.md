...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gEOYsbU4SE0r5If40b2Ywwsyotq29nZQYLME3nPfVkrzdD2JsD5tfk44hog6Mc3U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.278.0/index.min.mjs": "sha384-gEOYsbU4SE0r5If40b2Ywwsyotq29nZQYLME3nPfVkrzdD2JsD5tfk44hog6Mc3U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.278.0/LICENSE
```

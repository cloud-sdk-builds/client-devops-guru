...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SDXo8TtgXw9YGe9xR2NWupSAdCoSPrJvlvMyTOSMrFjW1kxMY1zfmUY1jmX/yKRF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.616.0/index.min.mjs": "sha384-SDXo8TtgXw9YGe9xR2NWupSAdCoSPrJvlvMyTOSMrFjW1kxMY1zfmUY1jmX/yKRF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.616.0/LICENSE
```

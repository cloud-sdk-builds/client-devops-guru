...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lH+yuAoNykESy1AP14SISHAdhXapK+v+7LEpYcR8R7/vYqUaeCQKikvdxaXF2VbC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1005.0/index.min.mjs": "sha384-lH+yuAoNykESy1AP14SISHAdhXapK+v+7LEpYcR8R7/vYqUaeCQKikvdxaXF2VbC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1005.0/LICENSE
```

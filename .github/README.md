...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8rVMvoWXEftcZbSv6ni1IQglH1RB7fP+2bstbdM1Yod2Qk7waU0ZehVNKxbgIxcQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1033.0/index.min.mjs": "sha384-8rVMvoWXEftcZbSv6ni1IQglH1RB7fP+2bstbdM1Yod2Qk7waU0ZehVNKxbgIxcQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1033.0/LICENSE
```

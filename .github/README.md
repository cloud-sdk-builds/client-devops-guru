...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f/2o8DnZgkVk/LL8mUsCdaIYT3dEdAcCMt+V7qXJDPOAg3MErZjtvm195qEJ8/+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.744.0/index.min.mjs": "sha384-f/2o8DnZgkVk/LL8mUsCdaIYT3dEdAcCMt+V7qXJDPOAg3MErZjtvm195qEJ8/+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.744.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SZr+0kCg+5SeA0iYnphN3W1HnPKUEM/elsoBkPPQET6UCCI6vELmjQDpuUoP6Jdp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.295.0/index.min.mjs": "sha384-SZr+0kCg+5SeA0iYnphN3W1HnPKUEM/elsoBkPPQET6UCCI6vELmjQDpuUoP6Jdp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O407UkWXNMSZSgDgi52eGurr1q8yZi1wmjXaU7XIrDeTnD5+vGqQv2G2F0oPelyr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.80.0/index.min.mjs": "sha384-O407UkWXNMSZSgDgi52eGurr1q8yZi1wmjXaU7XIrDeTnD5+vGqQv2G2F0oPelyr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.80.0/LICENSE
```

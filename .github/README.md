...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zNzBPbz4+oHPFd2ybK7yIKaj5m6oRITVkFJHerpiHWw++pvMYt40TCYflUFJTrAF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.635.0/index.min.mjs": "sha384-zNzBPbz4+oHPFd2ybK7yIKaj5m6oRITVkFJHerpiHWw++pvMYt40TCYflUFJTrAF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.635.0/LICENSE
```

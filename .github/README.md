...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GZQEJtOub04bje/LbZQIHLgMBX4obpCY4m9V/CzWJu69q4YzeNMEoI4d0rO0y8d+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.826.0/index.min.mjs": "sha384-GZQEJtOub04bje/LbZQIHLgMBX4obpCY4m9V/CzWJu69q4YzeNMEoI4d0rO0y8d+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.826.0/LICENSE
```

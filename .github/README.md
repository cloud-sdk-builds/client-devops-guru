...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.133.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.133.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mN6ocJJLtlBru0JEjSwXABDtHkQW7FS8avmFlBN1gpfSgYcMOXfLvkc6leqARICS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.133.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.133.0/index.min.mjs": "sha384-mN6ocJJLtlBru0JEjSwXABDtHkQW7FS8avmFlBN1gpfSgYcMOXfLvkc6leqARICS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.133.0/LICENSE
```

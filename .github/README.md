...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jGdPPQpj8TFsPFnG5Pbp0knV1aF9aIyiPtgn1sGIomauvax9M0bfPCplnVtlLZuz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.0/index.min.mjs": "sha384-jGdPPQpj8TFsPFnG5Pbp0knV1aF9aIyiPtgn1sGIomauvax9M0bfPCplnVtlLZuz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.13.0/LICENSE
```

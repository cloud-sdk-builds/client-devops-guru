...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uPIyavq8z5WfZa4SvWGlLZ4i3z43VGDpXyBj9npy0pjHobvm9vfoZ13AlvrKE/G7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.196.0/index.min.mjs": "sha384-uPIyavq8z5WfZa4SvWGlLZ4i3z43VGDpXyBj9npy0pjHobvm9vfoZ13AlvrKE/G7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.196.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ymBMv6SjveeASIKgO9dB5alKcRDkOGfjyUpfSj5uvMxUlqZZe9vy9aOz96kN2R/s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.46.0/index.min.mjs": "sha384-ymBMv6SjveeASIKgO9dB5alKcRDkOGfjyUpfSj5uvMxUlqZZe9vy9aOz96kN2R/s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.46.0/LICENSE
```

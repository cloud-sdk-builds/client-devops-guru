...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-25S6IFhtNKSeifFDO8Z9pJxdI7e2LnrZIuFrtGXdsXGmJoN6F6MacxTcPl78zy+r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.981.0/index.min.mjs": "sha384-25S6IFhtNKSeifFDO8Z9pJxdI7e2LnrZIuFrtGXdsXGmJoN6F6MacxTcPl78zy+r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.981.0/LICENSE
```

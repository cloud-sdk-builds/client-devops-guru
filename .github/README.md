...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BUxRBoKpSx7EaYJ8bc5vvgrgVlNTMrYdaE00yUUM3VC/WLMPVArOxT+o29ovlRt/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.782.0/index.min.mjs": "sha384-BUxRBoKpSx7EaYJ8bc5vvgrgVlNTMrYdaE00yUUM3VC/WLMPVArOxT+o29ovlRt/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.782.0/LICENSE
```

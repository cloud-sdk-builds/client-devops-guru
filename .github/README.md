...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LsPUXBcmnZnX7fbX6DaxGdRIEXxyDqbJhGf0xurqOlt2S4Sop3YKqT4VmaN7TdFU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.0/index.min.mjs": "sha384-LsPUXBcmnZnX7fbX6DaxGdRIEXxyDqbJhGf0xurqOlt2S4Sop3YKqT4VmaN7TdFU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.36.0/LICENSE
```

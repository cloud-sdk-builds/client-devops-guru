...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w70ZjNVkk3k3PBwmLXl5K/WtbWP1oHPMsiw/SRjjkKRbvGvpeK4O37zpXou44l6P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.360.0/index.min.mjs": "sha384-w70ZjNVkk3k3PBwmLXl5K/WtbWP1oHPMsiw/SRjjkKRbvGvpeK4O37zpXou44l6P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.360.0/LICENSE
```

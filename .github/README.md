...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UAP6jCa6Kdxjwt5H/jgNE+gx2Ci8Ih1PO3DX20ybIEQjweoFTdpqMwoT/39UxUpn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.121.0/index.min.mjs": "sha384-UAP6jCa6Kdxjwt5H/jgNE+gx2Ci8Ih1PO3DX20ybIEQjweoFTdpqMwoT/39UxUpn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.121.0/LICENSE
```

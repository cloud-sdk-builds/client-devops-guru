...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1WAyexkshdU5luMbczsuZs1ru3A04FSFGDGv8GJ3WewFdJ9RGtatP0n8+MSYr9xY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.749.0/index.min.mjs": "sha384-1WAyexkshdU5luMbczsuZs1ru3A04FSFGDGv8GJ3WewFdJ9RGtatP0n8+MSYr9xY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.749.0/LICENSE
```

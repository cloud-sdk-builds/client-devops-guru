...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bcN27SG6aK7KvTKgs9elJnn8vCq/ZaJ+Q1fWqK3MBlpNtnOM8A/xAyxVNAXyz82w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.168.0/index.min.mjs": "sha384-bcN27SG6aK7KvTKgs9elJnn8vCq/ZaJ+Q1fWqK3MBlpNtnOM8A/xAyxVNAXyz82w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.168.0/LICENSE
```

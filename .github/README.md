...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7lB5RXI7mL8q4i1P85Vx2YZV3xuIl5lM4IIRagYfTMoRTz9wabjpMayUMbWjD3Jt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.162.0/index.min.mjs": "sha384-7lB5RXI7mL8q4i1P85Vx2YZV3xuIl5lM4IIRagYfTMoRTz9wabjpMayUMbWjD3Jt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.162.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+mGXwgAMuBd+GaLx3BtUsJQsFqMeod6xYBtKppn5kN6CfjEd3qeJ4ZFsqIiFcglQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1001.0/index.min.mjs": "sha384-+mGXwgAMuBd+GaLx3BtUsJQsFqMeod6xYBtKppn5kN6CfjEd3qeJ4ZFsqIiFcglQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1001.0/LICENSE
```

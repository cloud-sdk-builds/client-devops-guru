...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zJOYJzHfeYWENJmh/QTScAuq15FLthKc05LQG6VERGhRVhulSHktBwgg45tD0hdI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.215.0/index.min.mjs": "sha384-zJOYJzHfeYWENJmh/QTScAuq15FLthKc05LQG6VERGhRVhulSHktBwgg45tD0hdI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.215.0/LICENSE
```

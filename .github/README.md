...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RcZIy7Gdsj5zDpzd5vYLzjFBkoEHaURaaUSHMIHtwb0xDkfg2l57cF5PF85Ozwhe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.988.0/index.min.mjs": "sha384-RcZIy7Gdsj5zDpzd5vYLzjFBkoEHaURaaUSHMIHtwb0xDkfg2l57cF5PF85Ozwhe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.988.0/LICENSE
```

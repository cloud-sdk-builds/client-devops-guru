...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OA6IxAkWCJjNURfeG8NKeT6sTXeis5b7uR8QFu1BZKaE81Qi2TQHvtovC3xT9q21
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.208.0/index.min.mjs": "sha384-OA6IxAkWCJjNURfeG8NKeT6sTXeis5b7uR8QFu1BZKaE81Qi2TQHvtovC3xT9q21"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.208.0/LICENSE
```

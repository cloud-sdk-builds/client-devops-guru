...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WK3zCe7h6O/g7tNF+aU3CMom5GztFxC8oSqIOGMImULp+WmxNIKmEEdTvntzbUIe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.75.0/index.min.mjs": "sha384-WK3zCe7h6O/g7tNF+aU3CMom5GztFxC8oSqIOGMImULp+WmxNIKmEEdTvntzbUIe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.75.0/LICENSE
```

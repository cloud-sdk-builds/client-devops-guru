...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gtERqgIC+QYk/DaVHlbkV7VL+BRrEI3DEVFIY5XajAHvHKvGeVdugHn575NAV1Nl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.893.0/index.min.mjs": "sha384-gtERqgIC+QYk/DaVHlbkV7VL+BRrEI3DEVFIY5XajAHvHKvGeVdugHn575NAV1Nl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.893.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7XROSa4ehpa2i+a4CuBt969qR0OYWyVHJqbzzyUyKLU3ZPqs3Uc8kQCSd8DQeMeB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.502.0/index.min.mjs": "sha384-7XROSa4ehpa2i+a4CuBt969qR0OYWyVHJqbzzyUyKLU3ZPqs3Uc8kQCSd8DQeMeB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.502.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h9P9MmASMfaKM2QaMk0Ou1By5rB7m7yDiuFQmzM7/FNdBanTh6Iz19xiM6UVf4mx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.137.0/index.min.mjs": "sha384-h9P9MmASMfaKM2QaMk0Ou1By5rB7m7yDiuFQmzM7/FNdBanTh6Iz19xiM6UVf4mx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.137.0/LICENSE
```

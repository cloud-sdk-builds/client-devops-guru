...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u5v5ZAAJIWAf1mWyl4byAzMd9BmG24UC9HE2EdMW2+Fi6Z6TNM1RSoxRUwvWpIM7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1011.0/index.min.mjs": "sha384-u5v5ZAAJIWAf1mWyl4byAzMd9BmG24UC9HE2EdMW2+Fi6Z6TNM1RSoxRUwvWpIM7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1011.0/LICENSE
```

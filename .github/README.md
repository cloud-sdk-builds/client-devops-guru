...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ojD4GhoKIJPzFC1EzbkjCEKh11C9kwPUoJR6ACG8tm0JSewgSYeXtvc+c6ZzhyBy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.154.0/index.min.mjs": "sha384-ojD4GhoKIJPzFC1EzbkjCEKh11C9kwPUoJR6ACG8tm0JSewgSYeXtvc+c6ZzhyBy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.154.0/LICENSE
```

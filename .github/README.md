...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y2IFO3FWvBpdtf+FE5DqEX3U/pFm+DgSVkmyio86oJcltI6l6TU1aPSw0RNvoyWN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.45.0/index.min.mjs": "sha384-y2IFO3FWvBpdtf+FE5DqEX3U/pFm+DgSVkmyio86oJcltI6l6TU1aPSw0RNvoyWN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.45.0/LICENSE
```

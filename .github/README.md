...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BFD9AkXtWJAAbHz4idr5Sl9h9a1nPDkGLPVB4ZvcbE0Kvsn/kX1POKBZpLLgoJou
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.254.0/index.min.mjs": "sha384-BFD9AkXtWJAAbHz4idr5Sl9h9a1nPDkGLPVB4ZvcbE0Kvsn/kX1POKBZpLLgoJou"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.254.0/LICENSE
```

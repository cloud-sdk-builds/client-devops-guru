...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-dwtQIFxylSKqg1a7E0zwLZQTA9KKbLMrYXs2H2u1qWSpvcHnVKkIPBwySVQt29kv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.1/index.min.mjs": "sha384-dwtQIFxylSKqg1a7E0zwLZQTA9KKbLMrYXs2H2u1qWSpvcHnVKkIPBwySVQt29kv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.4.1/LICENSE
```

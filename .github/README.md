...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Uf110TFjgGtW6bRUyI6cVnv0YEHnaHMbpFlKsMsuLCdWFnpWdES4b0rDxD2Yo5N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.928.0/index.min.mjs": "sha384-7Uf110TFjgGtW6bRUyI6cVnv0YEHnaHMbpFlKsMsuLCdWFnpWdES4b0rDxD2Yo5N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.928.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/1/ZraUfNX8gkxi1bk+2eJ0Gchxhe9tsi0MtLacsW+MoIpK+q0cjMuLmpxcBsacY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.20.0/index.min.mjs": "sha384-/1/ZraUfNX8gkxi1bk+2eJ0Gchxhe9tsi0MtLacsW+MoIpK+q0cjMuLmpxcBsacY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.20.0/LICENSE
```

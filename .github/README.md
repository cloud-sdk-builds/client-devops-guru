...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lOVGw84IP/XKyQAmqdOMQDBCNHlsJ5CAyuVSebbifrUjQtXseLT5/Hyh5ujmgn/d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.507.0/index.min.mjs": "sha384-lOVGw84IP/XKyQAmqdOMQDBCNHlsJ5CAyuVSebbifrUjQtXseLT5/Hyh5ujmgn/d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.507.0/LICENSE
```

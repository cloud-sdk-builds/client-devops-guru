...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+q7dkVJkNCD5516Y0Eq/rFyMEPOvewS02CtmrumGJBWmXpCp9bYcLdgIt7CfNxUA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.666.0/index.min.mjs": "sha384-+q7dkVJkNCD5516Y0Eq/rFyMEPOvewS02CtmrumGJBWmXpCp9bYcLdgIt7CfNxUA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.666.0/LICENSE
```

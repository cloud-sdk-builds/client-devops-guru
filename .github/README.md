...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LyWkEimI4Uf6VJbIpugDh4YbtANmyJHPeG2JHZxAYX3Aovf0HQNh83sSRGhwlywo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.264.0/index.min.mjs": "sha384-LyWkEimI4Uf6VJbIpugDh4YbtANmyJHPeG2JHZxAYX3Aovf0HQNh83sSRGhwlywo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.264.0/LICENSE
```

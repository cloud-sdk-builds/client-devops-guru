...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-11a1aoenYGN7EvIj7sprYbXufZwLaabAVaghVHIV2eokmjP6Pw8jeq6BsdYesApE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.856.0/index.min.mjs": "sha384-11a1aoenYGN7EvIj7sprYbXufZwLaabAVaghVHIV2eokmjP6Pw8jeq6BsdYesApE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.856.0/LICENSE
```

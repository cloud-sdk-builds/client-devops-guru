...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l8q8+MKpVUfKfTrkAEpvlVzVlYup95Nt8atcoVvqmHTW8fmInu9GqJOEKmKT/QvO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.235.0/index.min.mjs": "sha384-l8q8+MKpVUfKfTrkAEpvlVzVlYup95Nt8atcoVvqmHTW8fmInu9GqJOEKmKT/QvO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.235.0/LICENSE
```

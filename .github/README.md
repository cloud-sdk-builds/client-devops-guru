...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-mxErD/MVH0e9f9ijwr3EopymQH03C1ThUR8uOk/cGyw58VcjFn27aR2R5lCEKCMq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.118.1/index.min.mjs": "sha384-mxErD/MVH0e9f9ijwr3EopymQH03C1ThUR8uOk/cGyw58VcjFn27aR2R5lCEKCMq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.118.1/LICENSE
```

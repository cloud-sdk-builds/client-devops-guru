...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WIcohBrGPvownmXAZIuFzvy3tYQk71/CHakwcWLM9iBGaL6P7JS9VjhvE3RXqo1H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.272.0/index.min.mjs": "sha384-WIcohBrGPvownmXAZIuFzvy3tYQk71/CHakwcWLM9iBGaL6P7JS9VjhvE3RXqo1H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.272.0/LICENSE
```

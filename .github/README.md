...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I8U+7lhNk+nOLsksL9h1D+RbQ6bcr1/dEFqafDpyoobbgi+9MrA5g0BGjyXKFtB3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.964.0/index.min.mjs": "sha384-I8U+7lhNk+nOLsksL9h1D+RbQ6bcr1/dEFqafDpyoobbgi+9MrA5g0BGjyXKFtB3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.964.0/LICENSE
```

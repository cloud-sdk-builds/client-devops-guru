...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E4gU+0UmLY93bi8S5UURRIkqgbJ0zHN+16SchSsMIUmhjb6EGn/xS3C86etdKB7e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.971.0/index.min.mjs": "sha384-E4gU+0UmLY93bi8S5UURRIkqgbJ0zHN+16SchSsMIUmhjb6EGn/xS3C86etdKB7e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.971.0/LICENSE
```

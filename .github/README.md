...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OTPVVutqBmoEepfRZr9PzVgGMksVHA++FPVUwXjWQp7guI2JkdOND7dB+l4uUgOm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.499.0/index.min.mjs": "sha384-OTPVVutqBmoEepfRZr9PzVgGMksVHA++FPVUwXjWQp7guI2JkdOND7dB+l4uUgOm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.499.0/LICENSE
```

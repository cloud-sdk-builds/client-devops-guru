...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CWUoBvBCRI+rmwToq6Xht80oK/xI4ztByBRblK5rDgQbtYucf2H2ZxrtzZqQkgfX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.16.0/index.min.mjs": "sha384-CWUoBvBCRI+rmwToq6Xht80oK/xI4ztByBRblK5rDgQbtYucf2H2ZxrtzZqQkgfX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.16.0/LICENSE
```

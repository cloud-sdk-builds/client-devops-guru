...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6FIBh+vb2i/th8Wp5o/Fl+6oou63ek9MR4LrnGW5av/GumSfs2ANh6QaPsGHZYr2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.890.0/index.min.mjs": "sha384-6FIBh+vb2i/th8Wp5o/Fl+6oou63ek9MR4LrnGW5av/GumSfs2ANh6QaPsGHZYr2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.890.0/LICENSE
```

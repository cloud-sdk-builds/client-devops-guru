...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rw1gwheCCVjIXZYsXVN7HZBOuXbnnQeM0y0kSo6UJ1Bmyo+ORtfHZBdoVa/qDV2H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.30.0/index.min.mjs": "sha384-Rw1gwheCCVjIXZYsXVN7HZBOuXbnnQeM0y0kSo6UJ1Bmyo+ORtfHZBdoVa/qDV2H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.30.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rvn82sxiLj4D4CM7c8tEVHN9YjoxQLdtPTvyLn4ixDhtTSQrBxh9nYBc1WOIANx0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.980.0/index.min.mjs": "sha384-Rvn82sxiLj4D4CM7c8tEVHN9YjoxQLdtPTvyLn4ixDhtTSQrBxh9nYBc1WOIANx0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.980.0/LICENSE
```

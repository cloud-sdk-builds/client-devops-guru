...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xvlC8Nh/TJ7ZI8NseA4lcYEqL3x0wvsuL8Wq6KUt1d18CcpsjTCwxNlZBpf5zUE7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.857.0/index.min.mjs": "sha384-xvlC8Nh/TJ7ZI8NseA4lcYEqL3x0wvsuL8Wq6KUt1d18CcpsjTCwxNlZBpf5zUE7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.857.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ds3WGcgBbcT8GfiGN3pXymDiDWoYBCJCqBK1xA3Q8I/mw4XIakNcWGmNnDtN7y1c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.621.0/index.min.mjs": "sha384-ds3WGcgBbcT8GfiGN3pXymDiDWoYBCJCqBK1xA3Q8I/mw4XIakNcWGmNnDtN7y1c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.621.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MRHVcEzWXbBukr/mDga/6GvmQc0tBwf48LySxHYkhwDXO0p89JyrlKzxum4S7zxG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.568.0/index.min.mjs": "sha384-MRHVcEzWXbBukr/mDga/6GvmQc0tBwf48LySxHYkhwDXO0p89JyrlKzxum4S7zxG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.568.0/LICENSE
```

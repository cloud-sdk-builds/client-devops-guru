...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OhMR2qhyFfvaE5lwjDAeRCpJPKgonbcZdoAwfE5mZ5Mod/EZP1BLl5th92+lx2yl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.609.0/index.min.mjs": "sha384-OhMR2qhyFfvaE5lwjDAeRCpJPKgonbcZdoAwfE5mZ5Mod/EZP1BLl5th92+lx2yl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.609.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-3tW/vwIMOV3/lWOiZjoVV3QQClgS0mxBJNHbZcdMZcQOBTOg3Kxf6zXgVAaZicW9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.321.1/index.min.mjs": "sha384-3tW/vwIMOV3/lWOiZjoVV3QQClgS0mxBJNHbZcdMZcQOBTOg3Kxf6zXgVAaZicW9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.321.1/LICENSE
```

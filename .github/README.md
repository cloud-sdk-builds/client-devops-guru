...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MiX+ZOM4nwXd7oojgFahj9KKXxTNzs5YbjLiVSBujJxGzfB7i6NxrQ812hbQ9gKZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.437.0/index.min.mjs": "sha384-MiX+ZOM4nwXd7oojgFahj9KKXxTNzs5YbjLiVSBujJxGzfB7i6NxrQ812hbQ9gKZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.437.0/LICENSE
```

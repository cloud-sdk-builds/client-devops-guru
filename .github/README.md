...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3JV0s2uaWx81PaUYqFjlm8njcJcY+R3vm7j9N9urOdKDFQZQOxhkOCQtvHoNvR3t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.241.0/index.min.mjs": "sha384-3JV0s2uaWx81PaUYqFjlm8njcJcY+R3vm7j9N9urOdKDFQZQOxhkOCQtvHoNvR3t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.241.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.69.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.69.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XUbo+aN0NJChawvu3BPa1UhodqIz8x4jVLbprnVIXcWDerUKvy6By6HXA+MEU97L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.69.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.69.0/index.min.mjs": "sha384-XUbo+aN0NJChawvu3BPa1UhodqIz8x4jVLbprnVIXcWDerUKvy6By6HXA+MEU97L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.69.0/LICENSE
```

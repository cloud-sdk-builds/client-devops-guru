...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S8pEMA+evBs0BfXSwuKHb7+ynK1pfPiIbVS6Rpu3xqiW9CG99HeRDFeadQ62s8Wm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.575.0/index.min.mjs": "sha384-S8pEMA+evBs0BfXSwuKHb7+ynK1pfPiIbVS6Rpu3xqiW9CG99HeRDFeadQ62s8Wm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.575.0/LICENSE
```

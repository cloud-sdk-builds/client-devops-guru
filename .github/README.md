...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/eUcvTjYcLU6VX4G6RldVwWBMlWK59FZsvRbPjfWCAOrK7/pohb3RCYMz4THujOQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.15.0/index.min.mjs": "sha384-/eUcvTjYcLU6VX4G6RldVwWBMlWK59FZsvRbPjfWCAOrK7/pohb3RCYMz4THujOQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.15.0/LICENSE
```

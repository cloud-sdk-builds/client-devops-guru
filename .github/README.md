...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-spJNHKnbMS7QL/2C7hszXdkuGD1JaGA7pIxjoPJ6XD+mYvyluUWfTv5TNUJbuyoR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.730.0/index.min.mjs": "sha384-spJNHKnbMS7QL/2C7hszXdkuGD1JaGA7pIxjoPJ6XD+mYvyluUWfTv5TNUJbuyoR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.730.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hMZM12tSc9ZKYnW6H5T/DvIclstLAbNkUDe/5risfRPFjW6gJXd9mD/MlXfiAXS6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.598.0/index.min.mjs": "sha384-hMZM12tSc9ZKYnW6H5T/DvIclstLAbNkUDe/5risfRPFjW6gJXd9mD/MlXfiAXS6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.598.0/LICENSE
```

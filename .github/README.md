...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tLJqgwTfOouBhQjbBTP1eGU5mMK+69xg4vdgxSC1mPOVWzxOonKtUb9MTsu/dZvM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.37.0/index.min.mjs": "sha384-tLJqgwTfOouBhQjbBTP1eGU5mMK+69xg4vdgxSC1mPOVWzxOonKtUb9MTsu/dZvM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.37.0/LICENSE
```

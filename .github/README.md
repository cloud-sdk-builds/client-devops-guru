...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+IyLgz7t2GDTElbZzmsmAW8ASfMcrzSh6g9lPbtPwv6WWDqJ9dmPf0k89FEKXScH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.342.0/index.min.mjs": "sha384-+IyLgz7t2GDTElbZzmsmAW8ASfMcrzSh6g9lPbtPwv6WWDqJ9dmPf0k89FEKXScH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.342.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-He9h5nhdmlIDt81/gpoXJJSWItAx7Wd/5ulm8iUNScDCDfhDoGRVV/J+krA6i6LH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.142.0/index.min.mjs": "sha384-He9h5nhdmlIDt81/gpoXJJSWItAx7Wd/5ulm8iUNScDCDfhDoGRVV/J+krA6i6LH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.142.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9VIXNSipC/IQfmcdJhf+oFMnAi1XonaQbX1dOlk0/3cVKcWrfiFRXYoIFD9ut1f0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.978.0/index.min.mjs": "sha384-9VIXNSipC/IQfmcdJhf+oFMnAi1XonaQbX1dOlk0/3cVKcWrfiFRXYoIFD9ut1f0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.978.0/LICENSE
```

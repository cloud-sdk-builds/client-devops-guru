...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sQNGqrj8gF6uOYXjW489dEVPSIr8f1YswF/QdCX8x3mEUv5YrLQefRFl7mZqa4Z3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.620.1/index.min.mjs": "sha384-sQNGqrj8gF6uOYXjW489dEVPSIr8f1YswF/QdCX8x3mEUv5YrLQefRFl7mZqa4Z3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.620.1/LICENSE
```

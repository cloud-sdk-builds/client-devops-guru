...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e47K2NtN/lballBCyMChVeqUl3K/B9g/qnWvsJXEZwn53geX99/gYbwvXuLnIWKR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.799.0/index.min.mjs": "sha384-e47K2NtN/lballBCyMChVeqUl3K/B9g/qnWvsJXEZwn53geX99/gYbwvXuLnIWKR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.799.0/LICENSE
```

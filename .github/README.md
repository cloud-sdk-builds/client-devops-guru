...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-+orLnI0IIcg1ohgHHa3mHKiRGHrZegY9frsaFgh3i1be6lvtXTdhjpiXlKTJ9yuw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.1/index.min.mjs": "sha384-+orLnI0IIcg1ohgHHa3mHKiRGHrZegY9frsaFgh3i1be6lvtXTdhjpiXlKTJ9yuw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.47.1/LICENSE
```

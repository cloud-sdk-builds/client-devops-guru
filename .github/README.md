...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MGj4totih7XXFEkczb8wylrlLMPx/ESq2ee84Vr83OzTWp5k2MTHyOOadlyMDsrW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.408.0/index.min.mjs": "sha384-MGj4totih7XXFEkczb8wylrlLMPx/ESq2ee84Vr83OzTWp5k2MTHyOOadlyMDsrW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.408.0/LICENSE
```

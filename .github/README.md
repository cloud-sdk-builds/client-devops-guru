...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JFUQYvomRQtzT3GKAHOBQQ6UpQ5n5icdRSKeJ+lzju0Qh/wq9uBcTguUbJL1pEEh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.682.0/index.min.mjs": "sha384-JFUQYvomRQtzT3GKAHOBQQ6UpQ5n5icdRSKeJ+lzju0Qh/wq9uBcTguUbJL1pEEh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.682.0/LICENSE
```

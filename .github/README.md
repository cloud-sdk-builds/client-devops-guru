...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Apjd8JO4cKKAPo+46yUcEtmdNe3TyNy6/3YRQrtzi4z5Jejw9Biy15R+UxF5DGg5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.347.0/index.min.mjs": "sha384-Apjd8JO4cKKAPo+46yUcEtmdNe3TyNy6/3YRQrtzi4z5Jejw9Biy15R+UxF5DGg5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.347.0/LICENSE
```

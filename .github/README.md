...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qZqBk57SJ21enfkaew+AHEBnznI57b+NEbo7Tf5E0Y8nc7mypRjQYf+HG99wREu7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.51.0/index.min.mjs": "sha384-qZqBk57SJ21enfkaew+AHEBnznI57b+NEbo7Tf5E0Y8nc7mypRjQYf+HG99wREu7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.51.0/LICENSE
```

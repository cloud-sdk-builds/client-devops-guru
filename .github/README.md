...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5OBv9MFhnQYNA4jLfzwT0HIW8RP+RMfr37iE6dGE+xfBFFV6/1vf9kyJD68j/oRE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.461.0/index.min.mjs": "sha384-5OBv9MFhnQYNA4jLfzwT0HIW8RP+RMfr37iE6dGE+xfBFFV6/1vf9kyJD68j/oRE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.461.0/LICENSE
```

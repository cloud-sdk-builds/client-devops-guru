...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nav2vb3i2IubLAnSaBlqP37jdFpeQMX0G5/Zfjjfzoig14lQ3hPaaKlj7D24epqa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.997.0/index.min.mjs": "sha384-Nav2vb3i2IubLAnSaBlqP37jdFpeQMX0G5/Zfjjfzoig14lQ3hPaaKlj7D24epqa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.997.0/LICENSE
```

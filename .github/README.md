...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zVkXFn5ksWUA4YZv0ITQgFt4KG6aSDEpww7ztklnmuKo9OiuCSmiPYn2Tml70a3H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.796.0/index.min.mjs": "sha384-zVkXFn5ksWUA4YZv0ITQgFt4KG6aSDEpww7ztklnmuKo9OiuCSmiPYn2Tml70a3H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.796.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-oDRVTZVWILhsCxed269SkjA03iKhKg0z+e39CtoTe2FSpKac7Yiln/QNUxUep1Bc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.36.1/index.min.mjs": "sha384-oDRVTZVWILhsCxed269SkjA03iKhKg0z+e39CtoTe2FSpKac7Yiln/QNUxUep1Bc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.36.1/LICENSE
```

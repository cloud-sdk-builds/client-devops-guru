...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-98bV6gpfS2JwYa1CyRviiCNyT6WeQrp4pErhEAg//sEFcBuvuZji0FDdueLNSEkz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.825.0/index.min.mjs": "sha384-98bV6gpfS2JwYa1CyRviiCNyT6WeQrp4pErhEAg//sEFcBuvuZji0FDdueLNSEkz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.825.0/LICENSE
```

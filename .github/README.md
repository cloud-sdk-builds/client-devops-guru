...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JeAC42W8WA6etyAcslxQJj0u5BQbYWdn53WGZpR43YsdrQnJiVAHw1m6SNiKN90f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.967.0/index.min.mjs": "sha384-JeAC42W8WA6etyAcslxQJj0u5BQbYWdn53WGZpR43YsdrQnJiVAHw1m6SNiKN90f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.967.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CJvypV4vPM5W4QKse+Fy80NDrl8ss92IZ6J4ZCe6YebWAoq0YCXCdzPU94zpzWVI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.52.0/index.min.mjs": "sha384-CJvypV4vPM5W4QKse+Fy80NDrl8ss92IZ6J4ZCe6YebWAoq0YCXCdzPU94zpzWVI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.52.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.44.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.44.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z438961aD7hSUoSeicBdS12HY+03ooU56h5mJewphmjMq89AOwDwNlFIbzZvspbt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.44.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.44.0/index.min.mjs": "sha384-z438961aD7hSUoSeicBdS12HY+03ooU56h5mJewphmjMq89AOwDwNlFIbzZvspbt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.44.0/LICENSE
```

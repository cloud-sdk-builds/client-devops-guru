...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6foQmzwx/JEeZaQa+mzYRkeqPddyeGc7pQVgvs+kZerqg4DkmgrnZ9b7YHlTrZAf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.803.0/index.min.mjs": "sha384-6foQmzwx/JEeZaQa+mzYRkeqPddyeGc7pQVgvs+kZerqg4DkmgrnZ9b7YHlTrZAf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.803.0/LICENSE
```

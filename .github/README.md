...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aKyNdJjCAFbDPUdfLcKJUPPqbHJqiBIC1ayAuXHfsqF/X0a1OT9LVs3B/xM7AsBv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.484.0/index.min.mjs": "sha384-aKyNdJjCAFbDPUdfLcKJUPPqbHJqiBIC1ayAuXHfsqF/X0a1OT9LVs3B/xM7AsBv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.484.0/LICENSE
```

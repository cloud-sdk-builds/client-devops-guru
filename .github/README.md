...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xOipUYWdr5eHQ4/TIKsZa1QmgX32HO3wTztIONEA37InZEKqojaYPh6q0P8/RKuP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.0/index.min.mjs": "sha384-xOipUYWdr5eHQ4/TIKsZa1QmgX32HO3wTztIONEA37InZEKqojaYPh6q0P8/RKuP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.658.0/LICENSE
```

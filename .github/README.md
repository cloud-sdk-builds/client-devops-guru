...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FPenYblD6mxUn61gmS5oY83K/YNk93NZPQLmv/k4w+XK0YUNDDK5+0zxL6tPfIWJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.267.0/index.min.mjs": "sha384-FPenYblD6mxUn61gmS5oY83K/YNk93NZPQLmv/k4w+XK0YUNDDK5+0zxL6tPfIWJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.267.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dxv7tKn6gm9x48dLT+U2vQDaqY/6cAt8AYp510+AOyY0dcqTQ2y+Wq6ItLVLr8lm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.271.0/index.min.mjs": "sha384-dxv7tKn6gm9x48dLT+U2vQDaqY/6cAt8AYp510+AOyY0dcqTQ2y+Wq6ItLVLr8lm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.271.0/LICENSE
```

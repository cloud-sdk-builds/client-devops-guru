...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AjW7pDzQkR+93z836L+Mqd05ynAkEu+PoQCfh6CFfty8SEoM6EpcDQDt3gf9trT2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.864.0/index.min.mjs": "sha384-AjW7pDzQkR+93z836L+Mqd05ynAkEu+PoQCfh6CFfty8SEoM6EpcDQDt3gf9trT2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.864.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pqO1TR7+tlaH21PIopUxg4NHsKzOAFDFEOIrvRDKTTFdIg8VM0gvGgnFtzSKQ87v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.387.0/index.min.mjs": "sha384-pqO1TR7+tlaH21PIopUxg4NHsKzOAFDFEOIrvRDKTTFdIg8VM0gvGgnFtzSKQ87v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.387.0/LICENSE
```

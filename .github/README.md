...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TvwAfI8koa+l58tsetyK/+xd/Ko6k2S5ebLbNVaiuvnvKNkeZLo03Ip5YwORFzhc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.806.0/index.min.mjs": "sha384-TvwAfI8koa+l58tsetyK/+xd/Ko6k2S5ebLbNVaiuvnvKNkeZLo03Ip5YwORFzhc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.806.0/LICENSE
```

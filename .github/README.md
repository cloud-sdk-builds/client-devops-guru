...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IaZwX9G4vVl1BtpwW4mSuAqS3LzQSMOfHc0QGf/vaYBtNoJLr4WTwdizMLJYDqW/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.299.0/index.min.mjs": "sha384-IaZwX9G4vVl1BtpwW4mSuAqS3LzQSMOfHc0QGf/vaYBtNoJLr4WTwdizMLJYDqW/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.299.0/LICENSE
```

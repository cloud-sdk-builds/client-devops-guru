...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KaEjXLfpMhp0HsW6WX9ke0gsNj/iFros9CPbk3ku+pamYPw5JFjKdTZ00KlEK7Vt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.947.0/index.min.mjs": "sha384-KaEjXLfpMhp0HsW6WX9ke0gsNj/iFros9CPbk3ku+pamYPw5JFjKdTZ00KlEK7Vt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.947.0/LICENSE
```

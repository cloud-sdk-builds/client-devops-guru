...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zooGR+yjBd5oARtiRApaL00dx7osMn0KefFlF1WZd5H8TyL8p+Xrz/vxkyCTwjgG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.667.0/index.min.mjs": "sha384-zooGR+yjBd5oARtiRApaL00dx7osMn0KefFlF1WZd5H8TyL8p+Xrz/vxkyCTwjgG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.667.0/LICENSE
```

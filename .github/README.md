...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.674.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.674.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SAQCKBmPvfgPhRD5MeSAg7PoGQh55OZauO0GIxpCmsJp/CP0dLtbwf24a2DTG2Fe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.674.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.674.0/index.min.mjs": "sha384-SAQCKBmPvfgPhRD5MeSAg7PoGQh55OZauO0GIxpCmsJp/CP0dLtbwf24a2DTG2Fe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.674.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kTTzDeRo3qiuGfv3yA8dgacBGr31l0Nt8rX8NroBbJKBcCzJTuWNoo0EA8BarBpc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.190.0/index.min.mjs": "sha384-kTTzDeRo3qiuGfv3yA8dgacBGr31l0Nt8rX8NroBbJKBcCzJTuWNoo0EA8BarBpc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.190.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p1XpvxjS+ypR2i5t8bucyYePj8dkLgWtPyIO5ETuQQlz6QJMZmHh6ftsyc650OlX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.975.0/index.min.mjs": "sha384-p1XpvxjS+ypR2i5t8bucyYePj8dkLgWtPyIO5ETuQQlz6QJMZmHh6ftsyc650OlX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.975.0/LICENSE
```

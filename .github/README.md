...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2WS/+4/KY1EmIRJ9HPJV0Ssa0A4zgtgrjmUZ2YJS5RgTLLGSlJ/UzT6hcPwrrM2z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.32.0/index.min.mjs": "sha384-2WS/+4/KY1EmIRJ9HPJV0Ssa0A4zgtgrjmUZ2YJS5RgTLLGSlJ/UzT6hcPwrrM2z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.32.0/LICENSE
```

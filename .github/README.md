...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pu9qdVUlAW0ejz1lgSKh8rvh7cvOqo8nz2GTzeKCql7CFDal6JKOB4QYaAyf30dN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.983.0/index.min.mjs": "sha384-Pu9qdVUlAW0ejz1lgSKh8rvh7cvOqo8nz2GTzeKCql7CFDal6JKOB4QYaAyf30dN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.983.0/LICENSE
```

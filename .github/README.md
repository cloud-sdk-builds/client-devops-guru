...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IAny0wjpZcY8FnnWqHEDUrGFwWdBQhrfUi0m9bI1t2q/Gj2ujnh/1gaRAtBSOUqZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.954.0/index.min.mjs": "sha384-IAny0wjpZcY8FnnWqHEDUrGFwWdBQhrfUi0m9bI1t2q/Gj2ujnh/1gaRAtBSOUqZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.954.0/LICENSE
```

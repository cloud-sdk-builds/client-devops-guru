...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UyxxXnWQH5VeL1I25P5G2d9bzbSpV8wJ56bQeJTwQZWqQD8nwvaixSLKOLR3t5LJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.592.0/index.min.mjs": "sha384-UyxxXnWQH5VeL1I25P5G2d9bzbSpV8wJ56bQeJTwQZWqQD8nwvaixSLKOLR3t5LJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.592.0/LICENSE
```

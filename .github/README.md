...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pRLO6wlkdyIhiFVrwE5agauPEJK2SAnpBhKq30uvpTpJnx4nucjE8et3NYxOOu1U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.50.0/index.min.mjs": "sha384-pRLO6wlkdyIhiFVrwE5agauPEJK2SAnpBhKq30uvpTpJnx4nucjE8et3NYxOOu1U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.50.0/LICENSE
```

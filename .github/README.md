...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JKhxgcVy29b8aTubkPwI0Xpg5r7oJJbJvmdw2iHQ++MvgryKiW1+oOb4z2u1QE3H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.410.0/index.min.mjs": "sha384-JKhxgcVy29b8aTubkPwI0Xpg5r7oJJbJvmdw2iHQ++MvgryKiW1+oOb4z2u1QE3H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.410.0/LICENSE
```

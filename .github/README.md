...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z61z23cOk3Twlqyqs2IaA6he3NM09ee9v9rAdJKqXL0zltAjvHIsf/8xuwDKyssw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.1/index.min.mjs": "sha384-Z61z23cOk3Twlqyqs2IaA6he3NM09ee9v9rAdJKqXL0zltAjvHIsf/8xuwDKyssw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.503.1/LICENSE
```

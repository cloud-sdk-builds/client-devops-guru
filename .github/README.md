...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mPXsk4yCMTO5NDdKstfUBCkumZI3+Trmx+9trxZ8tFwk/fliTMsjp9zWPhOprbl1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.170.0/index.min.mjs": "sha384-mPXsk4yCMTO5NDdKstfUBCkumZI3+Trmx+9trxZ8tFwk/fliTMsjp9zWPhOprbl1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.170.0/LICENSE
```

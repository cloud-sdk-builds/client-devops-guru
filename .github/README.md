...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O9aH9bThJ0a8XHqD1kgt6EsYDlbrGCnkno68ByJamMIpNRT0jQDEMpcZa+jLRViB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.966.0/index.min.mjs": "sha384-O9aH9bThJ0a8XHqD1kgt6EsYDlbrGCnkno68ByJamMIpNRT0jQDEMpcZa+jLRViB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.966.0/LICENSE
```

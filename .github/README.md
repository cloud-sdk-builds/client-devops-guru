...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RcbrHBtsf11EogyecdKw7hZOk7Wiqe9hcpIPFvbylOWBo7kfWELxtlLw6D4n7GNm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.423.0/index.min.mjs": "sha384-RcbrHBtsf11EogyecdKw7hZOk7Wiqe9hcpIPFvbylOWBo7kfWELxtlLw6D4n7GNm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.423.0/LICENSE
```

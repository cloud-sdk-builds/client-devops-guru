...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Eu79JZRpP6jBHPl5c3DLbmf+PuJpQtCFJmL2qss9Q+v7MM2Onf2/uxRwVGnyoVXV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.953.0/index.min.mjs": "sha384-Eu79JZRpP6jBHPl5c3DLbmf+PuJpQtCFJmL2qss9Q+v7MM2Onf2/uxRwVGnyoVXV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.953.0/LICENSE
```

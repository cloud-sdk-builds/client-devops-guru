...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O4axUrUWbdkNqdhL072mZ/zd5m686NEM+SuQawVcPsXOBj7eHzrcSiPgh56mC3xt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.810.0/index.min.mjs": "sha384-O4axUrUWbdkNqdhL072mZ/zd5m686NEM+SuQawVcPsXOBj7eHzrcSiPgh56mC3xt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.810.0/LICENSE
```

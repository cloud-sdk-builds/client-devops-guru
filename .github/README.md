...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7WdiTNewMJYwENXFK5tCp02i/CAZe3frryn8StohnqRHC98BtrQpxj5TpzJ+XYdx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.523.0/index.min.mjs": "sha384-7WdiTNewMJYwENXFK5tCp02i/CAZe3frryn8StohnqRHC98BtrQpxj5TpzJ+XYdx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O9Z9FCGdHxghCPhRvZhSH0viH1ocMZd/rRkNjBSioTvGRW82PJN70dU+zzIuF/Cs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.535.0/index.min.mjs": "sha384-O9Z9FCGdHxghCPhRvZhSH0viH1ocMZd/rRkNjBSioTvGRW82PJN70dU+zzIuF/Cs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.535.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YDRaWJXivOjyZdrIeCOVmoLP1+DrY2T9noIckKqAjTS9jI7N1rZuMjx0jUWPR2Ya
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.210.0/index.min.mjs": "sha384-YDRaWJXivOjyZdrIeCOVmoLP1+DrY2T9noIckKqAjTS9jI7N1rZuMjx0jUWPR2Ya"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.210.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-78RlAYFec5YDdp5MX263FFyol1qxbSJSBuTrD7HcHBbKdCHrRniY54SeXZ2o/bpU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.679.0/index.min.mjs": "sha384-78RlAYFec5YDdp5MX263FFyol1qxbSJSBuTrD7HcHBbKdCHrRniY54SeXZ2o/bpU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.679.0/LICENSE
```

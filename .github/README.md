...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d7q6t/5JkvhJvpuXeqh6gRMxCSs4qoMaGzV1NZ25rirKR8DWdyQgJOLp2wJs8E5s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.4.0/index.min.mjs": "sha384-d7q6t/5JkvhJvpuXeqh6gRMxCSs4qoMaGzV1NZ25rirKR8DWdyQgJOLp2wJs8E5s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.4.0/LICENSE
```

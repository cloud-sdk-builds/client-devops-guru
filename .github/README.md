...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V/7jn7RrMeFWeAMWtCXJl0jAbb0qKOwnRML6TvZVAKG/wWp/PvJKIkBYhJqMC9Tk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.489.0/index.min.mjs": "sha384-V/7jn7RrMeFWeAMWtCXJl0jAbb0qKOwnRML6TvZVAKG/wWp/PvJKIkBYhJqMC9Tk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.489.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V06U31CJFgc6M5ucxJaCZyoemigrmBgufjRHmAHxQ8IsLeWhHhq5mrsneJe8EqLi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.993.0/index.min.mjs": "sha384-V06U31CJFgc6M5ucxJaCZyoemigrmBgufjRHmAHxQ8IsLeWhHhq5mrsneJe8EqLi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.993.0/LICENSE
```

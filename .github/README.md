...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aIxFwQJ435q8QghNMda7z8h7grGIC80566KNRKsIHoFtbdbCi+BsUvuQlo7V2f8m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1024.0/index.min.mjs": "sha384-aIxFwQJ435q8QghNMda7z8h7grGIC80566KNRKsIHoFtbdbCi+BsUvuQlo7V2f8m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1024.0/LICENSE
```

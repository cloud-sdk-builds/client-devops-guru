...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W1uV7mmLnzUQqcVZOfwPTco6v1k1yT51OLoRtJ62uwbrkdH9JdYfbKw/9cdf93GD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.293.0/index.min.mjs": "sha384-W1uV7mmLnzUQqcVZOfwPTco6v1k1yT51OLoRtJ62uwbrkdH9JdYfbKw/9cdf93GD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.293.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-/b+xQp4wfY7iaZONjUYdl+aJxuILE2lQxK1qWvUI0Ff6OJureCI3P2bRrn06c16X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.529.1/index.min.mjs": "sha384-/b+xQp4wfY7iaZONjUYdl+aJxuILE2lQxK1qWvUI0Ff6OJureCI3P2bRrn06c16X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.529.1/LICENSE
```

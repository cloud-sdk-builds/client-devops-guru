...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bjr7Etq86IAvOdf0h5F5t+nfrrzQC5vSTsZ0sh+7Q0BatU2BJaWekhxe+uKBVqLc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1019.0/index.min.mjs": "sha384-Bjr7Etq86IAvOdf0h5F5t+nfrrzQC5vSTsZ0sh+7Q0BatU2BJaWekhxe+uKBVqLc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1019.0/LICENSE
```

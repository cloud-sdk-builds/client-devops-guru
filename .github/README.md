...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oDic1cM9D3zh+0jkqt2GNFyPHNAQK6Mm9UfUwJ27wCKT23r4hsBj/WDvBIVAkF4T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.957.0/index.min.mjs": "sha384-oDic1cM9D3zh+0jkqt2GNFyPHNAQK6Mm9UfUwJ27wCKT23r4hsBj/WDvBIVAkF4T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.957.0/LICENSE
```

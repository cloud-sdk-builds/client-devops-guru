...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V4NaUywFWDX82f0Um2qaUNd/R/6J4dTNgrwJiVr5CfG63NGDVOkfi03fxgs3D8Lw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.0/index.min.mjs": "sha384-V4NaUywFWDX82f0Um2qaUNd/R/6J4dTNgrwJiVr5CfG63NGDVOkfi03fxgs3D8Lw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.266.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W8jqcU6jT0j5vbLBaKHgIxx31urUMAu/30ezycuRyMe8gEsXyt/vFweVZ2q3Ge9G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.919.0/index.min.mjs": "sha384-W8jqcU6jT0j5vbLBaKHgIxx31urUMAu/30ezycuRyMe8gEsXyt/vFweVZ2q3Ge9G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.919.0/LICENSE
```

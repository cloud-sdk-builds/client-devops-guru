...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L6Pye5QbgKY6epw9lH6fMIfKngIjgtrJ/e3zhS7TjgZevJ/VSu+0IW+fsVr3g/6n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.315.0/index.min.mjs": "sha384-L6Pye5QbgKY6epw9lH6fMIfKngIjgtrJ/e3zhS7TjgZevJ/VSu+0IW+fsVr3g/6n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.315.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4Cg1ZoExEW5k4jxAwy32EsRijkto+DYAM+AjErv22bwrAAs6czs4tVYWK0vHRglK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.294.0/index.min.mjs": "sha384-4Cg1ZoExEW5k4jxAwy32EsRijkto+DYAM+AjErv22bwrAAs6czs4tVYWK0vHRglK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2F0NrpBV6ben5ooka271eRSxrbvlm0SYCZlLEcW+YxKbj4qKwQ3cJ3wIJFaHcDyR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.901.0/index.min.mjs": "sha384-2F0NrpBV6ben5ooka271eRSxrbvlm0SYCZlLEcW+YxKbj4qKwQ3cJ3wIJFaHcDyR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.901.0/LICENSE
```

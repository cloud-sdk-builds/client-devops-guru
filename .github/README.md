...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yOqRdERPEEPstMz9SrOl98YEKgCx4T/dQ1RxOV2Mzn4pjRmFnLGJWUR9jAccz+aG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.662.0/index.min.mjs": "sha384-yOqRdERPEEPstMz9SrOl98YEKgCx4T/dQ1RxOV2Mzn4pjRmFnLGJWUR9jAccz+aG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.662.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O+CmHo5uH42bVPc5+NikeGj9m68F6/GL5vhV6MbikapvdOwKBP/+WEKvoisoNh1S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1023.0/index.min.mjs": "sha384-O+CmHo5uH42bVPc5+NikeGj9m68F6/GL5vhV6MbikapvdOwKBP/+WEKvoisoNh1S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1023.0/LICENSE
```

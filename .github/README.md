...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-uo7Z4DgsuZMWU/DRoqXYhDiXFuCq3bYK04BPqHomWUoDfDrq/W7TfKVbRTKFeRUX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.379.1/index.min.mjs": "sha384-uo7Z4DgsuZMWU/DRoqXYhDiXFuCq3bYK04BPqHomWUoDfDrq/W7TfKVbRTKFeRUX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.379.1/LICENSE
```

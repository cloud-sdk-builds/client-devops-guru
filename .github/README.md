...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A6pGPy92E43GObrhiLGV4dL+eZPXtf8O+IaQIXaIHmKy7mmhmkR4+hJFXfbn/jmQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.927.0/index.min.mjs": "sha384-A6pGPy92E43GObrhiLGV4dL+eZPXtf8O+IaQIXaIHmKy7mmhmkR4+hJFXfbn/jmQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.927.0/LICENSE
```

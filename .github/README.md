...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1C8jXhwpArp+z71RNVt4dLMmg5vgdkOSGzRFOgJs/mbTP8ahgo8n1ACBg3Ihe8ng
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.996.0/index.min.mjs": "sha384-1C8jXhwpArp+z71RNVt4dLMmg5vgdkOSGzRFOgJs/mbTP8ahgo8n1ACBg3Ihe8ng"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.996.0/LICENSE
```

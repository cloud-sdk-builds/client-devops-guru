...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OBLUR3Ar1TPljOAKUVpcbfSwc51aC2bDY7wVziE41U9/ETMKze8xUAIPwepsOVVC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.388.0/index.min.mjs": "sha384-OBLUR3Ar1TPljOAKUVpcbfSwc51aC2bDY7wVziE41U9/ETMKze8xUAIPwepsOVVC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.388.0/LICENSE
```

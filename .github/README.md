...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pKsY79Tu2cwKiFh/1iuRQ8RMNV+bCxyroB7F/eEWKcR4tZOKKX2Hjd6LMq2v7rUJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.56.0/index.min.mjs": "sha384-pKsY79Tu2cwKiFh/1iuRQ8RMNV+bCxyroB7F/eEWKcR4tZOKKX2Hjd6LMq2v7rUJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.56.0/LICENSE
```

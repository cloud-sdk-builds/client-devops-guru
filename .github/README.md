...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HRMX+uxKb40muL/mViKTsRPx82O7E1QD2V6tS8I+swBCmK5mpAACliV5tfRrCLLf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.319.0/index.min.mjs": "sha384-HRMX+uxKb40muL/mViKTsRPx82O7E1QD2V6tS8I+swBCmK5mpAACliV5tfRrCLLf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.319.0/LICENSE
```

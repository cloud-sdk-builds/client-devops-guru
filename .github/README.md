...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FFmhhNyJvbkNq72QS5UcKetw7aA0cMwsLr+yTV2aM7RfpMYG4yNKJrhQOy0MNEda
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.624.0/index.min.mjs": "sha384-FFmhhNyJvbkNq72QS5UcKetw7aA0cMwsLr+yTV2aM7RfpMYG4yNKJrhQOy0MNEda"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.624.0/LICENSE
```

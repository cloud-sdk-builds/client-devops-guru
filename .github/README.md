...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PFfO6Fcflt214gzDvkiwwgXqKeBQop++x7us5mG9QWOeDbCnH6WbIpWkO8hbjChD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.929.0/index.min.mjs": "sha384-PFfO6Fcflt214gzDvkiwwgXqKeBQop++x7us5mG9QWOeDbCnH6WbIpWkO8hbjChD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.929.0/LICENSE
```

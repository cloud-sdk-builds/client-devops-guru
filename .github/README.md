...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uVHs5i6PFNvp/PkPaG6kXbWC1Lrv8XidSm8BIzuKZ83BTT67xcd39R0xeScR3QdS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.257.0/index.min.mjs": "sha384-uVHs5i6PFNvp/PkPaG6kXbWC1Lrv8XidSm8BIzuKZ83BTT67xcd39R0xeScR3QdS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.257.0/LICENSE
```

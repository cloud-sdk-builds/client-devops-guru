...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nPqB+kmR5jsA1pA7jgCp/cxsPCis6VGFrUPoA7V5sVVa0HhxfBC2UC62vhyZecvJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.894.0/index.min.mjs": "sha384-nPqB+kmR5jsA1pA7jgCp/cxsPCis6VGFrUPoA7V5sVVa0HhxfBC2UC62vhyZecvJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.894.0/LICENSE
```

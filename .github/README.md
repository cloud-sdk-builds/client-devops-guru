...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-CckKtDlNBm/SH86FQ41Zz6V+bV7jy3am6U1BM+ikqEILP8KiIj6S6bn4YOfHk3gc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.1/index.min.mjs": "sha384-CckKtDlNBm/SH86FQ41Zz6V+bV7jy3am6U1BM+ikqEILP8KiIj6S6bn4YOfHk3gc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.726.1/LICENSE
```

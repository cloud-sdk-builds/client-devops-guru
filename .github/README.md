...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x/Q9XMHw0GT3VJvwzpxRN2dHl7rBq4aBfnWJRG1F8ZrUyGUS8Nu/XTgMpFsCon95
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.741.0/index.min.mjs": "sha384-x/Q9XMHw0GT3VJvwzpxRN2dHl7rBq4aBfnWJRG1F8ZrUyGUS8Nu/XTgMpFsCon95"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.741.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aNK1pnbBTrd9Wog16KZA9eV+k2VtcILA2t9sykWhm1xxurDrq90sdlf7btV3r7TQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.984.0/index.min.mjs": "sha384-aNK1pnbBTrd9Wog16KZA9eV+k2VtcILA2t9sykWhm1xxurDrq90sdlf7btV3r7TQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.984.0/LICENSE
```

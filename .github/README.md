...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HHcvFULy2BZ2bWcnojt95hROa4m+TX3wVcDB8JsF6oEKi/n6shYuqZT8+HO2+tbe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.310.0/index.min.mjs": "sha384-HHcvFULy2BZ2bWcnojt95hROa4m+TX3wVcDB8JsF6oEKi/n6shYuqZT8+HO2+tbe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.310.0/LICENSE
```

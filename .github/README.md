...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Pgy9OF8WmcOg/4y2tOmyqaWJ6d0j/cpbJvLO5JMpdYPxRT0kYxLw8Bwn76XOSUd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.962.0/index.min.mjs": "sha384-1Pgy9OF8WmcOg/4y2tOmyqaWJ6d0j/cpbJvLO5JMpdYPxRT0kYxLw8Bwn76XOSUd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.962.0/LICENSE
```

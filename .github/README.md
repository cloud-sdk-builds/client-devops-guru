...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WzmiIHCqr/0Jh1ZLVDDixh47wA3F9POQm7GueEod8NyCncfbBs4oTQfVuza/HkUi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.0/index.min.mjs": "sha384-WzmiIHCqr/0Jh1ZLVDDixh47wA3F9POQm7GueEod8NyCncfbBs4oTQfVuza/HkUi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.47.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3pM4QyfW7kAeSidi6QcRFYMuxbPQQkpFH1pSGs14JV5gi8kj+d37tENDjbMp3BAf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.179.0/index.min.mjs": "sha384-3pM4QyfW7kAeSidi6QcRFYMuxbPQQkpFH1pSGs14JV5gi8kj+d37tENDjbMp3BAf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.179.0/LICENSE
```

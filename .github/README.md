...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-663KJ+aw7EvzGVNCFQLE30FnuAXfKd699DmJdAR/ZLke+IeP+uBL9qfj7Khqzmwt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.623.0/index.min.mjs": "sha384-663KJ+aw7EvzGVNCFQLE30FnuAXfKd699DmJdAR/ZLke+IeP+uBL9qfj7Khqzmwt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.623.0/LICENSE
```

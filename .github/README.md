...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SbYVOUyQlfB//mwyQua5EEMNb6CKjBmCejgA+7Z5YwzGgISTrtxYcaIQV82fk7Uj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.476.0/index.min.mjs": "sha384-SbYVOUyQlfB//mwyQua5EEMNb6CKjBmCejgA+7Z5YwzGgISTrtxYcaIQV82fk7Uj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.476.0/LICENSE
```

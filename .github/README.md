...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rQCSkp3tCgH9R8OzwA0LbVoCq1BPfDDBqmiUoBOymel73XJmyiWRn4VZ/7b5iYG7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.218.0/index.min.mjs": "sha384-rQCSkp3tCgH9R8OzwA0LbVoCq1BPfDDBqmiUoBOymel73XJmyiWRn4VZ/7b5iYG7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.218.0/LICENSE
```

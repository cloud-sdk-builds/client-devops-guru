...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Qi+Y1uvQWOr5/sNOGh2ZT/o3uxvPcxD1LMwlqvafnnhSYtxAaqysi0b+ChCugIR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.163.0/index.min.mjs": "sha384-+Qi+Y1uvQWOr5/sNOGh2ZT/o3uxvPcxD1LMwlqvafnnhSYtxAaqysi0b+ChCugIR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.163.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PVRyYXg7aO1YnQD7BvjpslB8BoMz3oWHNDnMB+a7leed3AKiH31Ta3dARmwCtdg2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.216.0/index.min.mjs": "sha384-PVRyYXg7aO1YnQD7BvjpslB8BoMz3oWHNDnMB+a7leed3AKiH31Ta3dARmwCtdg2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.216.0/LICENSE
```

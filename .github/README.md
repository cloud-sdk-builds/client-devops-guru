...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QD+uBNyegc8k6n1A4RPAvMscGyt6a3r/dCGaO+dpucbaTw1grZQIxTyRRPlFkJ4B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.632.0/index.min.mjs": "sha384-QD+uBNyegc8k6n1A4RPAvMscGyt6a3r/dCGaO+dpucbaTw1grZQIxTyRRPlFkJ4B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.632.0/LICENSE
```

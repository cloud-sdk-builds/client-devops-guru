...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jjwNzKcsoWwRFwFHyF2atC5d/3bgKsbeeDoJMQs3kW+vqDvei32c2PLykGN4UW37
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.816.0/index.min.mjs": "sha384-jjwNzKcsoWwRFwFHyF2atC5d/3bgKsbeeDoJMQs3kW+vqDvei32c2PLykGN4UW37"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.816.0/LICENSE
```

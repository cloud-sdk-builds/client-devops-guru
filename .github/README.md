...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-97Ee961SOuSRbXfO/v9gl4LM8hBtv1mL5Z1LAYFBJvnvL7S//8GAuLIC08Uq6lIx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.622.0/index.min.mjs": "sha384-97Ee961SOuSRbXfO/v9gl4LM8hBtv1mL5Z1LAYFBJvnvL7S//8GAuLIC08Uq6lIx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.622.0/LICENSE
```

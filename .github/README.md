...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oOEUyzYlA5q8e7rpr8JTZdPdSt7IA6GyVx/QmUa6geNvm8M5+2AYKzQfnIA+B3OX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.25.0/index.min.mjs": "sha384-oOEUyzYlA5q8e7rpr8JTZdPdSt7IA6GyVx/QmUa6geNvm8M5+2AYKzQfnIA+B3OX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.25.0/LICENSE
```

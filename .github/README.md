...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-04usNV35RldTCNyfAv9epnOZbSO0oIWkWgeQyaVHSAMSS0AIIHa6a+wDB+yD33vU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.940.0/index.min.mjs": "sha384-04usNV35RldTCNyfAv9epnOZbSO0oIWkWgeQyaVHSAMSS0AIIHa6a+wDB+yD33vU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.940.0/LICENSE
```

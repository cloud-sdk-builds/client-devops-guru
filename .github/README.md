...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JKA0bcsSgiaXtpV0gTRd3kAao1sawGEhkrL+TIZibwh7Q1QmjgzkwHpHsvuC0B9f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.496.0/index.min.mjs": "sha384-JKA0bcsSgiaXtpV0gTRd3kAao1sawGEhkrL+TIZibwh7Q1QmjgzkwHpHsvuC0B9f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.496.0/LICENSE
```

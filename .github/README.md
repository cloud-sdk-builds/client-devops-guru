...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/gxyY3btnInYTF8CORD4H/YBF4Va1hter7U/Mx8skgLU4vvJOemc9UQVI+XLlemb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.382.0/index.min.mjs": "sha384-/gxyY3btnInYTF8CORD4H/YBF4Va1hter7U/Mx8skgLU4vvJOemc9UQVI+XLlemb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.382.0/LICENSE
```

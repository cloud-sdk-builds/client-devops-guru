...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7+ViC+Uu1BtTK+FSYHb3p8cfZtBsWgRyUZptxU0Q8w7QlUg1HP/kNsvB4KYkUKhC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.613.0/index.min.mjs": "sha384-7+ViC+Uu1BtTK+FSYHb3p8cfZtBsWgRyUZptxU0Q8w7QlUg1HP/kNsvB4KYkUKhC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.613.0/LICENSE
```

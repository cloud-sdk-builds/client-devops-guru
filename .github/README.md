...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9j13koDdDX9Ga9hWeVhDoI1uCQ8Fyqx46qjFjbe5JFZnMVrWwCFDU2KqhihRvkfD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.24.0/index.min.mjs": "sha384-9j13koDdDX9Ga9hWeVhDoI1uCQ8Fyqx46qjFjbe5JFZnMVrWwCFDU2KqhihRvkfD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.24.0/LICENSE
```

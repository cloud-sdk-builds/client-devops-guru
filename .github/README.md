...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k1cYrsiMWFUT+/sKDUiChgWXKUTWcq/CQ8TY/OpEccJqU9GNLXddQ80T3ZaQSGS2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.846.0/index.min.mjs": "sha384-k1cYrsiMWFUT+/sKDUiChgWXKUTWcq/CQ8TY/OpEccJqU9GNLXddQ80T3ZaQSGS2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.846.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QmEt8utlobvMkrT640l7yBsqfj8Q+Afdzg2CNzTgMSmZlOaDeHrpFtFWlRfkkZmK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.992.0/index.min.mjs": "sha384-QmEt8utlobvMkrT640l7yBsqfj8Q+Afdzg2CNzTgMSmZlOaDeHrpFtFWlRfkkZmK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.992.0/LICENSE
```

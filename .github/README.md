...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xNNVpoMTCwBn/m15XA3ZpUDd6+1hlqd/NPyi3TIPbKcgP0nXraMpgiLHlabrkvOd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.178.0/index.min.mjs": "sha384-xNNVpoMTCwBn/m15XA3ZpUDd6+1hlqd/NPyi3TIPbKcgP0nXraMpgiLHlabrkvOd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.178.0/LICENSE
```

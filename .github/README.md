...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yRUu3iIJ6+QpuUwwMn9DqqgqRyr6jP7uG1PTgWrWJxEqgtmg95r93i4PQIbUioAb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.385.0/index.min.mjs": "sha384-yRUu3iIJ6+QpuUwwMn9DqqgqRyr6jP7uG1PTgWrWJxEqgtmg95r93i4PQIbUioAb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.385.0/LICENSE
```

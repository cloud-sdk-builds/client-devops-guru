...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1002.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1002.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k0MAHh2bkLo1gdFkHToUs0d9YbJul4nJSTCjXJ/UsqAJ77yDPHK4uCNp8Qd7iK+o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1002.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1002.0/index.min.mjs": "sha384-k0MAHh2bkLo1gdFkHToUs0d9YbJul4nJSTCjXJ/UsqAJ77yDPHK4uCNp8Qd7iK+o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1002.0/LICENSE
```

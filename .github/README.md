...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oG436P1daz4ATTVzBvEA9/9CrjV+9xPDD9WOSaUBBrCnH4yb8Z5ghWRvbK7dcrfp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.855.0/index.min.mjs": "sha384-oG436P1daz4ATTVzBvEA9/9CrjV+9xPDD9WOSaUBBrCnH4yb8Z5ghWRvbK7dcrfp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.855.0/LICENSE
```

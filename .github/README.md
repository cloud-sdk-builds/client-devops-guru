...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IU/GaGr30Z4teZqQj3Ytva9cmEtEi7RKq/vMk76ZaTCTQieDlvxJCeZbkWFWuC1I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.281.0/index.min.mjs": "sha384-IU/GaGr30Z4teZqQj3Ytva9cmEtEi7RKq/vMk76ZaTCTQieDlvxJCeZbkWFWuC1I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.281.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kmTZN165WzCPfaM6WMBxz3wOakslMKw5AY/AM7mP0H6m5+fU8901EsT/zvIXsEmp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.72.0/index.min.mjs": "sha384-kmTZN165WzCPfaM6WMBxz3wOakslMKw5AY/AM7mP0H6m5+fU8901EsT/zvIXsEmp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.72.0/LICENSE
```

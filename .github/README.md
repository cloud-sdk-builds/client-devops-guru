...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-5FSMJ0J6Zl9M41MPW8rK2cZAwrpbkmY7O+73UFxKNYSR6ZgwqOncZQnK6X69K3+T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.266.1/index.min.mjs": "sha384-5FSMJ0J6Zl9M41MPW8rK2cZAwrpbkmY7O+73UFxKNYSR6ZgwqOncZQnK6X69K3+T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.266.1/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gM6J/iQRJC/A+qOQ+iXgrgxA62/RuspgHYTTJ9Aa/xXMgE/uibIdilnaf1vpRnIv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.650.0/index.min.mjs": "sha384-gM6J/iQRJC/A+qOQ+iXgrgxA62/RuspgHYTTJ9Aa/xXMgE/uibIdilnaf1vpRnIv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.650.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z6eCUGV0K6FP8U9ZBWtV7EvRzxbYjXivC3Vd59FElfOEig7XYJx9riGOLXW5coks
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.921.0/index.min.mjs": "sha384-Z6eCUGV0K6FP8U9ZBWtV7EvRzxbYjXivC3Vd59FElfOEig7XYJx9riGOLXW5coks"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.921.0/LICENSE
```

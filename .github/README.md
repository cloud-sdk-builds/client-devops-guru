...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cHasc0KdqEf+4MHi+9019n8n3UAe+TT9AMmkDTRg0nCSywFEZ/hWGLpC6gJ3rvN1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.279.0/index.min.mjs": "sha384-cHasc0KdqEf+4MHi+9019n8n3UAe+TT9AMmkDTRg0nCSywFEZ/hWGLpC6gJ3rvN1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.279.0/LICENSE
```

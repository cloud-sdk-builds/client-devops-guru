...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-MdNDjyaaEdS5qgYn7DloSxwdOZJNH3y+qOE7aLRubGVuLaHs/35W92tJ3yzQBmM6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.731.1/index.min.mjs": "sha384-MdNDjyaaEdS5qgYn7DloSxwdOZJNH3y+qOE7aLRubGVuLaHs/35W92tJ3yzQBmM6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.731.1/LICENSE
```

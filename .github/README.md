...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UL2sgGHJP3lGHzf5OXQqTH9siw4NiW97MgsXIG1WgN8mSB+R5w0pLOP31TVPL1jZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.933.0/index.min.mjs": "sha384-UL2sgGHJP3lGHzf5OXQqTH9siw4NiW97MgsXIG1WgN8mSB+R5w0pLOP31TVPL1jZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.933.0/LICENSE
```

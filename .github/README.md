...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-exwbtNmcoUOVz21G5RI5jam9PS0qHPMDppOBdaH8eXbHgpIDwQAqzQM3ryRLiz4j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.9.0/index.min.mjs": "sha384-exwbtNmcoUOVz21G5RI5jam9PS0qHPMDppOBdaH8eXbHgpIDwQAqzQM3ryRLiz4j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.9.0/LICENSE
```

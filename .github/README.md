...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yS87sVoqq8m3hC47NpJL6Qa7K0BAnnrURcyLgF3+eGlv6fuhdHBBz+aK90hE2fgj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.987.0/index.min.mjs": "sha384-yS87sVoqq8m3hC47NpJL6Qa7K0BAnnrURcyLgF3+eGlv6fuhdHBBz+aK90hE2fgj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.987.0/LICENSE
```

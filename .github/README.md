...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CRhIv+amGN873DY4hYJiI5ze7/GLGp2uwQVjcBjNux6irVabJXXONV8VAYZ7q1Xr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.17.0/index.min.mjs": "sha384-CRhIv+amGN873DY4hYJiI5ze7/GLGp2uwQVjcBjNux6irVabJXXONV8VAYZ7q1Xr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.17.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-zoypn1GgYSmoh7uvufph5RtPlQLewWPadpdYHrBEK9J06eCQCt+MFtYUUuzZe97L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.13.1/index.min.mjs": "sha384-zoypn1GgYSmoh7uvufph5RtPlQLewWPadpdYHrBEK9J06eCQCt+MFtYUUuzZe97L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.13.1/LICENSE
```

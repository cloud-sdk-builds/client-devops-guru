...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Aqa5yGb4GhzoXXPMs8H06PHZdrFtq9/j6Yg+3naE747pDsyyCvRQ5gefa7Yluzze
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.6.1/index.min.mjs": "sha384-Aqa5yGb4GhzoXXPMs8H06PHZdrFtq9/j6Yg+3naE747pDsyyCvRQ5gefa7Yluzze"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.6.1/LICENSE
```

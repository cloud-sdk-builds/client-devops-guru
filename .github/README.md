...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MyWE3MRcI8C7KXgsbeHNSSbkmnCrpYOqZM9xoOZQybWphCrgzFo2xqzhNwU5ZEa2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.478.0/index.min.mjs": "sha384-MyWE3MRcI8C7KXgsbeHNSSbkmnCrpYOqZM9xoOZQybWphCrgzFo2xqzhNwU5ZEa2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.478.0/LICENSE
```

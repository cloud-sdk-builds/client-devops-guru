...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+iFAbHtdYLvtwv8TlpwIsEl26tPfqAWJ4ADSWmeNT9spbWCLmICKRgaOP3zi/E8t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.362.0/index.min.mjs": "sha384-+iFAbHtdYLvtwv8TlpwIsEl26tPfqAWJ4ADSWmeNT9spbWCLmICKRgaOP3zi/E8t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.362.0/LICENSE
```

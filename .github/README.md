...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ogi/2lglIEtusMw/htPYI+ZVXqWWJVYkmNpG2GhAW9zMx9uPV34BsDyHBNOtzyyo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.709.0/index.min.mjs": "sha384-Ogi/2lglIEtusMw/htPYI+ZVXqWWJVYkmNpG2GhAW9zMx9uPV34BsDyHBNOtzyyo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.709.0/LICENSE
```

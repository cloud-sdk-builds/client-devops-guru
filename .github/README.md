...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZmKjRZtIKZcK/uxq9+Zx/wSHdXKqG0V2ZDLEBt1efN7KzsXkD1N/+NBlo4JDTTOc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.85.0/index.min.mjs": "sha384-ZmKjRZtIKZcK/uxq9+Zx/wSHdXKqG0V2ZDLEBt1efN7KzsXkD1N/+NBlo4JDTTOc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.85.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txJI1lshw0q54bHv2kITSmNjZqrTVHWmeV9S/nSXAdY3nFS5ys09abA97mvwFepM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.363.0/index.min.mjs": "sha384-txJI1lshw0q54bHv2kITSmNjZqrTVHWmeV9S/nSXAdY3nFS5ys09abA97mvwFepM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.363.0/LICENSE
```

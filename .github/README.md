...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vlJ9FgtkxhZVBavZ8DALlVaSLDdyHa+3GXc3ijAgLXOUMCCgHkz4id/4gTY0F0kn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.972.0/index.min.mjs": "sha384-vlJ9FgtkxhZVBavZ8DALlVaSLDdyHa+3GXc3ijAgLXOUMCCgHkz4id/4gTY0F0kn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.972.0/LICENSE
```

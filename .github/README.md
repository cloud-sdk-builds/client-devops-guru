...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KTKqdexg0hKTmMi/Qu5eTMvr26aeqE0u4tipfXygEUwUwBVcRcxvXthWdqZIOJVZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.920.0/index.min.mjs": "sha384-KTKqdexg0hKTmMi/Qu5eTMvr26aeqE0u4tipfXygEUwUwBVcRcxvXthWdqZIOJVZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.920.0/LICENSE
```

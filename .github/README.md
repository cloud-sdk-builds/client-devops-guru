...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z46NCY3Ohb04bwVah7AeKxTIF7Z/qPHupT8bNYZKzh2pjFJujIyqOkWQNeHxisRa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.23.0/index.min.mjs": "sha384-Z46NCY3Ohb04bwVah7AeKxTIF7Z/qPHupT8bNYZKzh2pjFJujIyqOkWQNeHxisRa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.23.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nrenAue3Gd4DJ+O7WdT9yQ3GzYXlf+UQHC4FJ6eJmhEXEsYTP30saGQ/kXARPH++
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.696.0/index.min.mjs": "sha384-nrenAue3Gd4DJ+O7WdT9yQ3GzYXlf+UQHC4FJ6eJmhEXEsYTP30saGQ/kXARPH++"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.696.0/LICENSE
```

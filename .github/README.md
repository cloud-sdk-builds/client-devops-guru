...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mv2cJU2fdFc3Oxh4YnAb0evYTFlESxk84VfjpxOW9no4CTFBZXmecwphZXp6shze
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.49.0/index.min.mjs": "sha384-Mv2cJU2fdFc3Oxh4YnAb0evYTFlESxk84VfjpxOW9no4CTFBZXmecwphZXp6shze"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.49.0/LICENSE
```

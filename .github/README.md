...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5bmmJCt7WnZd+skqb5/0/8fmTDjBAwfUJl15sArWX1ttQSKaOxpyEeZvaY1JRSHf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.348.0/index.min.mjs": "sha384-5bmmJCt7WnZd+skqb5/0/8fmTDjBAwfUJl15sArWX1ttQSKaOxpyEeZvaY1JRSHf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.348.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x8op86EfR1rFMDW3NFDIWFWG0kacEzvRGzOBa0wV8GrzzMENsqSSrzucugBf0z+I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.956.0/index.min.mjs": "sha384-x8op86EfR1rFMDW3NFDIWFWG0kacEzvRGzOBa0wV8GrzzMENsqSSrzucugBf0z+I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.956.0/LICENSE
```

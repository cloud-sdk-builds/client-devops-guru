...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hFdvf8o2mJhmVpIcR2BCQp8s4rYAkVpUZTBULhe4jLqTtjFricVjp/bd94z7QtMB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.358.0/index.min.mjs": "sha384-hFdvf8o2mJhmVpIcR2BCQp8s4rYAkVpUZTBULhe4jLqTtjFricVjp/bd94z7QtMB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.358.0/LICENSE
```

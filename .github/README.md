...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HRvYY++xnU9bDz6R7HStFmSC7R3Vxe+VpgcX1kAEzejSEGJuFABas5BM/VyzyXBj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.946.0/index.min.mjs": "sha384-HRvYY++xnU9bDz6R7HStFmSC7R3Vxe+VpgcX1kAEzejSEGJuFABas5BM/VyzyXBj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.946.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kWwVrtFxxi13s42w0rWntmoyKeIfa/xTir9MhC/9GcODI38B6SwH8Bh5rocFoxof
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.990.0/index.min.mjs": "sha384-kWwVrtFxxi13s42w0rWntmoyKeIfa/xTir9MhC/9GcODI38B6SwH8Bh5rocFoxof"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.990.0/LICENSE
```

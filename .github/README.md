...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nnTySZq5rKtSBDnBbspvw+FJKDGETRwNn9JNdWWZ9/mi2Pzvdzd8eN7kgVA2VOFK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.328.0/index.min.mjs": "sha384-nnTySZq5rKtSBDnBbspvw+FJKDGETRwNn9JNdWWZ9/mi2Pzvdzd8eN7kgVA2VOFK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.328.0/LICENSE
```

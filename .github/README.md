...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rXfgvGyUodp9nHcSAV6g16xTrg6j/G8/m2rXJOCBRCBDJyNGlgvwpL3U6fbL+AUM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.236.0/index.min.mjs": "sha384-rXfgvGyUodp9nHcSAV6g16xTrg6j/G8/m2rXJOCBRCBDJyNGlgvwpL3U6fbL+AUM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.236.0/LICENSE
```

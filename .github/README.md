...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e0jIhfHnpr0TQBjSNXKQZ2y6VV9jhpNkjE4bEkYYJjshui5uW7/lGipwnP3/G9tG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.160.0/index.min.mjs": "sha384-e0jIhfHnpr0TQBjSNXKQZ2y6VV9jhpNkjE4bEkYYJjshui5uW7/lGipwnP3/G9tG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.160.0/LICENSE
```

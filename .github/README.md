...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bh1tkHtcONej1XLehcKXvf64VxNeF2eItABhBe1jHcWyW0lRjA1cJdXj+lxJpC1g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.353.0/index.min.mjs": "sha384-Bh1tkHtcONej1XLehcKXvf64VxNeF2eItABhBe1jHcWyW0lRjA1cJdXj+lxJpC1g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.353.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uLgjXnZ2Osj0xYMF5/buNVFG4WeRay6z8YmQ5fVlP7ELVYJayvTrVskhzuUtUOtn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.985.0/index.min.mjs": "sha384-uLgjXnZ2Osj0xYMF5/buNVFG4WeRay6z8YmQ5fVlP7ELVYJayvTrVskhzuUtUOtn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.985.0/LICENSE
```

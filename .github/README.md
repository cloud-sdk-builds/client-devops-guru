...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qrjmkx1xmgyl9uJ33i084AkKCCP+dPEWl2qnRnn+t86dB9DgcRka9YesprkmWqnR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.567.0/index.min.mjs": "sha384-Qrjmkx1xmgyl9uJ33i084AkKCCP+dPEWl2qnRnn+t86dB9DgcRka9YesprkmWqnR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.567.0/LICENSE
```

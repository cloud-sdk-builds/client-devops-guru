...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b3jE+2EcY/2n/Exw5LdJJokWsTU2nWofFiTnItF6C4g0pSAX/O+pY+phPxpJHjsM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.943.0/index.min.mjs": "sha384-b3jE+2EcY/2n/Exw5LdJJokWsTU2nWofFiTnItF6C4g0pSAX/O+pY+phPxpJHjsM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.943.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-82aOS9+jSaIKvG/8amMqmD21VFBjh9ESZlX/AqNeK1OMGnFv8IBeRqQVU8hEfCHQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.503.0/index.min.mjs": "sha384-82aOS9+jSaIKvG/8amMqmD21VFBjh9ESZlX/AqNeK1OMGnFv8IBeRqQVU8hEfCHQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.503.0/LICENSE
```

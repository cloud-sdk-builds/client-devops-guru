...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l7Z9iRJ1DEaYPfYuLQP4etIxXiD12JQSS4/FO6gCPCHGeLGS/l2C7m60mOnDQdSp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.808.0/index.min.mjs": "sha384-l7Z9iRJ1DEaYPfYuLQP4etIxXiD12JQSS4/FO6gCPCHGeLGS/l2C7m60mOnDQdSp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.808.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CUwWB0d0vZuIYDfoCGz1V2G0juH3M/h8d8MHM0rVqVMNBdDmATqH5jvhmb1w3OG7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.999.0/index.min.mjs": "sha384-CUwWB0d0vZuIYDfoCGz1V2G0juH3M/h8d8MHM0rVqVMNBdDmATqH5jvhmb1w3OG7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.999.0/LICENSE
```

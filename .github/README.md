...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GsdaniseFz8SLlNA7nnwfqQ+o3qdP49Og/plSsa5Ekw3e7YIBmOlW8YlTcJfEfXp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.287.0/index.min.mjs": "sha384-GsdaniseFz8SLlNA7nnwfqQ+o3qdP49Og/plSsa5Ekw3e7YIBmOlW8YlTcJfEfXp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.287.0/LICENSE
```

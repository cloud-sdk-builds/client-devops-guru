...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bUkRHKFguj9RyRsU1TNuvBi4XcVa24eCs9umwpBpe9qll3nc4IDRe6Ft5cWZ6XuS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.994.0/index.min.mjs": "sha384-bUkRHKFguj9RyRsU1TNuvBi4XcVa24eCs9umwpBpe9qll3nc4IDRe6Ft5cWZ6XuS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.994.0/LICENSE
```

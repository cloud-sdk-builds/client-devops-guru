...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IlCdN6YI3awy+LWIfp9zGZ12WBijB6Kn3qpJxk1RPTudBQa0eG3lOzmmv+eeNcrO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.914.0/index.min.mjs": "sha384-IlCdN6YI3awy+LWIfp9zGZ12WBijB6Kn3qpJxk1RPTudBQa0eG3lOzmmv+eeNcrO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.914.0/LICENSE
```

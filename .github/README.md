...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kzyNppR/w2DGJ09bhTTny090rRiZUe9bNsDSmtA1zlOzuToMYQHFZOpj2BiU76AV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.297.0/index.min.mjs": "sha384-kzyNppR/w2DGJ09bhTTny090rRiZUe9bNsDSmtA1zlOzuToMYQHFZOpj2BiU76AV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.297.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w5pQRQs3LJFlz4lEfgyfy+AfJiXpu2YT0/s21IB1CxIiAjtVMPaV2tjnC8Xiwaxb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.511.0/index.min.mjs": "sha384-w5pQRQs3LJFlz4lEfgyfy+AfJiXpu2YT0/s21IB1CxIiAjtVMPaV2tjnC8Xiwaxb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.511.0/LICENSE
```

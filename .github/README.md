...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KXqpRUx7MYnAYFX1HA7lE6YHDvOZswGBws9NM2XJWmwcrqVDniFWbIXxPRUcIKB2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.180.0/index.min.mjs": "sha384-KXqpRUx7MYnAYFX1HA7lE6YHDvOZswGBws9NM2XJWmwcrqVDniFWbIXxPRUcIKB2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.180.0/LICENSE
```

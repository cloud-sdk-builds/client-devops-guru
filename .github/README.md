...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2gGP8T0tzJOlQRuE53N3YSCH2z6VbUp+Cq1egCUm6CNYwyvSv3WrNwq+wGYSKpi4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.377.0/index.min.mjs": "sha384-2gGP8T0tzJOlQRuE53N3YSCH2z6VbUp+Cq1egCUm6CNYwyvSv3WrNwq+wGYSKpi4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-WogkvT27kg0+HaDTIVoLMvhKA45OgiD4OQWEjvqYrgmXkndCOTWzs29OXTy/lFVZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.8.1/index.min.mjs": "sha384-WogkvT27kg0+HaDTIVoLMvhKA45OgiD4OQWEjvqYrgmXkndCOTWzs29OXTy/lFVZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.8.1/LICENSE
```

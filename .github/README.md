...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nvIF4R6s58IwZZHVAJ1jkT9s0c7QVTfkf2Lo8ULycVphh27W0T47auD5e1srKNP1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.54.0/index.min.mjs": "sha384-nvIF4R6s58IwZZHVAJ1jkT9s0c7QVTfkf2Lo8ULycVphh27W0T47auD5e1srKNP1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.54.0/LICENSE
```

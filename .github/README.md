...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q4NpKtaQHEvlZTvh2PsuW2uzCEVmVynmayxfLDyt8ZW5wOLdYY1aHFQkw1GKtuP8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.326.0/index.min.mjs": "sha384-q4NpKtaQHEvlZTvh2PsuW2uzCEVmVynmayxfLDyt8ZW5wOLdYY1aHFQkw1GKtuP8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.326.0/LICENSE
```

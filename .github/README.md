...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WCO72m0mQKw4DzPrJRQ+oj02JH2DYRE7y+JulVUZSbywvUZlniism8iaES5MoteO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.872.0/index.min.mjs": "sha384-WCO72m0mQKw4DzPrJRQ+oj02JH2DYRE7y+JulVUZSbywvUZlniism8iaES5MoteO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.872.0/LICENSE
```

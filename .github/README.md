...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tKBYMxR1MLejrOKY42GwxfPdPBPqV3xRoC1nqtstSDZOQEDXf2UxV5/i0W4vH2N4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.675.0/index.min.mjs": "sha384-tKBYMxR1MLejrOKY42GwxfPdPBPqV3xRoC1nqtstSDZOQEDXf2UxV5/i0W4vH2N4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.675.0/LICENSE
```

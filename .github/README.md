...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Fp44lmzOkgjT1dxLsVmxp1UEo+j0fWYQsggRyilrATpVTQCy+xgn2jFdM2Uxj7N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.549.0/index.min.mjs": "sha384-2Fp44lmzOkgjT1dxLsVmxp1UEo+j0fWYQsggRyilrATpVTQCy+xgn2jFdM2Uxj7N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.549.0/LICENSE
```

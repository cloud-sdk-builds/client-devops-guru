...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+hws1m2zg9wzcKV0MKAWYttvOLHYSWFYQlnX2HDAbol/GvgFlt0fnW1pWk0guWrd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.931.0/index.min.mjs": "sha384-+hws1m2zg9wzcKV0MKAWYttvOLHYSWFYQlnX2HDAbol/GvgFlt0fnW1pWk0guWrd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.931.0/LICENSE
```

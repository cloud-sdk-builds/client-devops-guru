...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H6tCQFSmwDrgyUtl1tA/V1Npa6f2JjKfwGMwWXL2WW93hKc91UMLoi4bMJozLdq5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.830.0/index.min.mjs": "sha384-H6tCQFSmwDrgyUtl1tA/V1Npa6f2JjKfwGMwWXL2WW93hKc91UMLoi4bMJozLdq5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.830.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+5fekH+b3UNQARswaKNeuOL2+MmwxPm+QPy9SpBOl3xG1aR4j7BI6Ikq0UVBSWRJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.298.0/index.min.mjs": "sha384-+5fekH+b3UNQARswaKNeuOL2+MmwxPm+QPy9SpBOl3xG1aR4j7BI6Ikq0UVBSWRJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.298.0/LICENSE
```

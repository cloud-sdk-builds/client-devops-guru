...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wQ7zOatgfL07uXO5sxvfmHmImBfMY9u0FYb5+cxFiMu8NkT/tYA6lhaju7KswFt+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.565.0/index.min.mjs": "sha384-wQ7zOatgfL07uXO5sxvfmHmImBfMY9u0FYb5+cxFiMu8NkT/tYA6lhaju7KswFt+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.565.0/LICENSE
```

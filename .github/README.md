...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mF2ujcz0SFBGS69opM9+WVS5qyYOBP8cA8GuW34cjlx34BUbreK9eVJxLKGqU/bA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.145.0/index.min.mjs": "sha384-mF2ujcz0SFBGS69opM9+WVS5qyYOBP8cA8GuW34cjlx34BUbreK9eVJxLKGqU/bA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.145.0/LICENSE
```

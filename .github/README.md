...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xee4PYicjAb24jSO3PnkzcbA5fq08DTkNsOzIYm+OYE916Phr76tUmVdy8eOWLdJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.245.0/index.min.mjs": "sha384-xee4PYicjAb24jSO3PnkzcbA5fq08DTkNsOzIYm+OYE916Phr76tUmVdy8eOWLdJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.245.0/LICENSE
```

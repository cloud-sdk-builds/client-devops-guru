...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VV9Yl+KlmvNq5HNQ3K9BPeOm25o2TrtVZlQsNdnM5wgc8pSnH6SoAvD6rWjzv7vc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.998.0/index.min.mjs": "sha384-VV9Yl+KlmvNq5HNQ3K9BPeOm25o2TrtVZlQsNdnM5wgc8pSnH6SoAvD6rWjzv7vc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.998.0/LICENSE
```

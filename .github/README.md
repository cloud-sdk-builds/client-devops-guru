...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iIGEByptA2tJEmVr9NIJWJiDqE/HTeBHKRHybAEgMKDA64Q+WHhNSbmqsv3Uig4b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.588.0/index.min.mjs": "sha384-iIGEByptA2tJEmVr9NIJWJiDqE/HTeBHKRHybAEgMKDA64Q+WHhNSbmqsv3Uig4b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.588.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h8gbW0AYJRwRslHRMDtlyvzO86mEKudBCY0XZqi/l1E4spKiKCflS9o8TK+Rzok9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.812.0/index.min.mjs": "sha384-h8gbW0AYJRwRslHRMDtlyvzO86mEKudBCY0XZqi/l1E4spKiKCflS9o8TK+Rzok9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.812.0/LICENSE
```

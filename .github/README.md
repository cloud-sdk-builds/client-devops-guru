...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i1oBV9yBX9OoVm1nLdb6PCil1p52QHE0eEAxSZ/+zUgPJPaEfmGn74ZYgnM+MUSA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.128.0/index.min.mjs": "sha384-i1oBV9yBX9OoVm1nLdb6PCil1p52QHE0eEAxSZ/+zUgPJPaEfmGn74ZYgnM+MUSA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.128.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yVN0RMcBeNRoxYa45NQuYl8OmwoA1Dpkq1SqYXY2uDIHVF1Mw+696R99LYPlEE4q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.10.0/index.min.mjs": "sha384-yVN0RMcBeNRoxYa45NQuYl8OmwoA1Dpkq1SqYXY2uDIHVF1Mw+696R99LYPlEE4q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.10.0/LICENSE
```

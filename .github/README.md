...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-as97uOQLMP+o1STKAyumUC1ZUMFgnfbF2YVJk7IfmpHZUbHhNEeW80k60vRh4IJ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.289.0/index.min.mjs": "sha384-as97uOQLMP+o1STKAyumUC1ZUMFgnfbF2YVJk7IfmpHZUbHhNEeW80k60vRh4IJ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.289.0/LICENSE
```

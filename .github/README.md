...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qyIqvdwIqqKWZhvMWnKy7KF+4IvnT754FvVC7XZ4oVMD4w3vReQYygi1RBUCgvBP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.828.0/index.min.mjs": "sha384-qyIqvdwIqqKWZhvMWnKy7KF+4IvnT754FvVC7XZ4oVMD4w3vReQYygi1RBUCgvBP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.828.0/LICENSE
```

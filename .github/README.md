...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j0XR7f3HM3HCTv4fm4T/17Oy5uprUciEUbVgN1IuZ5ePM/yvXMxht7m8QcYUaq3L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.895.0/index.min.mjs": "sha384-j0XR7f3HM3HCTv4fm4T/17Oy5uprUciEUbVgN1IuZ5ePM/yvXMxht7m8QcYUaq3L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.895.0/LICENSE
```

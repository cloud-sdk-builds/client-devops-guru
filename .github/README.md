...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EUqqO0yal9ltvmi8fHZ+PlAOeq1VQ7aKG1xato189tnQMYTyfkOKnr74qPbaKlOR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.777.0/index.min.mjs": "sha384-EUqqO0yal9ltvmi8fHZ+PlAOeq1VQ7aKG1xato189tnQMYTyfkOKnr74qPbaKlOR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.777.0/LICENSE
```

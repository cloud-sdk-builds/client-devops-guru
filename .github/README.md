...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2KswIaSuVaE98C7Rdv95XZ37CE6X3gJAqJ2KBByA8mMVKAr/sFdcDgxfB+N3cxMa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.723.0/index.min.mjs": "sha384-2KswIaSuVaE98C7Rdv95XZ37CE6X3gJAqJ2KBByA8mMVKAr/sFdcDgxfB+N3cxMa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.723.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GinqFpGm+kjbCOLm8fNFN6zjOFidR+MCLQBlZ46VKwLF7pWLSMLS+TMT3r9FhHia
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.212.0/index.min.mjs": "sha384-GinqFpGm+kjbCOLm8fNFN6zjOFidR+MCLQBlZ46VKwLF7pWLSMLS+TMT3r9FhHia"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.212.0/LICENSE
```

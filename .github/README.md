...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1006.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1006.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1R/j4NbWOXzT+G4tKBvkbkeljGloKMqWuO1JDk8BhnHxBp7tZW1CvagvRNP8jwW6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1006.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1006.0/index.min.mjs": "sha384-1R/j4NbWOXzT+G4tKBvkbkeljGloKMqWuO1JDk8BhnHxBp7tZW1CvagvRNP8jwW6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1006.0/LICENSE
```

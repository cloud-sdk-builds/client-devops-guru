...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yohNvC8FDrvJF15/Hm0SC/D/30dwb36QGbjP+apCY6GSclyIJLggP9vpGlTnee2h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.664.0/index.min.mjs": "sha384-yohNvC8FDrvJF15/Hm0SC/D/30dwb36QGbjP+apCY6GSclyIJLggP9vpGlTnee2h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.664.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Df8aji0U9U56NwqZ5zW/Vk9Zbcqrwqyqbut42vHzVhbbA7UcM+Mu8bZlmzXMZ3hB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.94.0/index.min.mjs": "sha384-Df8aji0U9U56NwqZ5zW/Vk9Zbcqrwqyqbut42vHzVhbbA7UcM+Mu8bZlmzXMZ3hB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.94.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GOlddY7NQ/wfaKhGIGLUg+9s4/Iq6pZc7mRlLI7t7W1dayIt/rf2cUCQdSztQd8m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.186.0/index.min.mjs": "sha384-GOlddY7NQ/wfaKhGIGLUg+9s4/Iq6pZc7mRlLI7t7W1dayIt/rf2cUCQdSztQd8m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.186.0/LICENSE
```

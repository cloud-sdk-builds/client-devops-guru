...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f/XfIXSkk7XHZykaOpYakWqwue/X7cP3vZkJ4Vm9PgEbJ9EBYvdTKOAsRgOnEOxS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.577.0/index.min.mjs": "sha384-f/XfIXSkk7XHZykaOpYakWqwue/X7cP3vZkJ4Vm9PgEbJ9EBYvdTKOAsRgOnEOxS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.577.0/LICENSE
```

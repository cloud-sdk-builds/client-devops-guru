...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yrIIlnQ9ju+iC9f9vwKMiJ1FOMsueTRpBobB2LRKPn9ULxpj8kHGSC9RHO7a8LHr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.338.0/index.min.mjs": "sha384-yrIIlnQ9ju+iC9f9vwKMiJ1FOMsueTRpBobB2LRKPn9ULxpj8kHGSC9RHO7a8LHr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.338.0/LICENSE
```

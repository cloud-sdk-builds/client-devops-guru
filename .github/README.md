...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HK5YizA4+MPAYOXdgNwZMDH6sVBfACzIYaYIhAS4AJMslOFNgTGf5L2l4TQZy4ap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.316.0/index.min.mjs": "sha384-HK5YizA4+MPAYOXdgNwZMDH6sVBfACzIYaYIhAS4AJMslOFNgTGf5L2l4TQZy4ap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.316.0/LICENSE
```

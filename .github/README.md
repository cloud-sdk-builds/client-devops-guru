...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w+9ACR8/GzjsayvEXF72FCDaaAm4EI1qptiR0WAz+vky+Kgh1cYPgDcAFq6cSCeq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.131.0/index.min.mjs": "sha384-w+9ACR8/GzjsayvEXF72FCDaaAm4EI1qptiR0WAz+vky+Kgh1cYPgDcAFq6cSCeq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.131.0/LICENSE
```

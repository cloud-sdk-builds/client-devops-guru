...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-biXMqBj9H7C0LBHoIaYS5yARF9gyAiLBgxAS1IiCxKOKIf5F3JfQgqwXd0qi9ffh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.521.0/index.min.mjs": "sha384-biXMqBj9H7C0LBHoIaYS5yARF9gyAiLBgxAS1IiCxKOKIf5F3JfQgqwXd0qi9ffh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.521.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wJ1bgvT9KO11kCgc8bWoInDH94CLi8aL7O1oJRr42RJ5M3UezAhppRW+DvI/erId
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.888.0/index.min.mjs": "sha384-wJ1bgvT9KO11kCgc8bWoInDH94CLi8aL7O1oJRr42RJ5M3UezAhppRW+DvI/erId"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.888.0/LICENSE
```

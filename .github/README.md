...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1MPPTCv9hHJxgEQHp35XnhzeTkFzowkWnNt0YJ8rVIJzlVHaP8kiMNfm4+WrvSCh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.41.0/index.min.mjs": "sha384-1MPPTCv9hHJxgEQHp35XnhzeTkFzowkWnNt0YJ8rVIJzlVHaP8kiMNfm4+WrvSCh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.41.0/LICENSE
```

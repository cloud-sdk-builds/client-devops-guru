...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qrNjfZ50D6YtW7PfW3D/3artDJXypwQFpmS/EWxRtLHfUpQ01FIgVJoBnP/rtE2W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.970.0/index.min.mjs": "sha384-qrNjfZ50D6YtW7PfW3D/3artDJXypwQFpmS/EWxRtLHfUpQ01FIgVJoBnP/rtE2W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.970.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7/G/oBWGJOAzr2S4v982y/feDjlicvgnW8KMXRxmZE+wCimz7KUipkxc+p+Pk3jb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.29.0/index.min.mjs": "sha384-7/G/oBWGJOAzr2S4v982y/feDjlicvgnW8KMXRxmZE+wCimz7KUipkxc+p+Pk3jb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.29.0/LICENSE
```

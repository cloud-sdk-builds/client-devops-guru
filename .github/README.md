...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4s9bb5u8S/xFB1/wRN1zyQz51QyxUoNQlQ3+6mHtRrADoH3VrsI+ptkg379AkrHf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.465.0/index.min.mjs": "sha384-4s9bb5u8S/xFB1/wRN1zyQz51QyxUoNQlQ3+6mHtRrADoH3VrsI+ptkg379AkrHf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.465.0/LICENSE
```

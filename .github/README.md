...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FSjgeqsD7sjvtS2V5/WZwjVeVn+3Dzz/gsLCaSLNMWJ68XnDkTe/Jg2+iM24RJ1w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.211.0/index.min.mjs": "sha384-FSjgeqsD7sjvtS2V5/WZwjVeVn+3Dzz/gsLCaSLNMWJ68XnDkTe/Jg2+iM24RJ1w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.211.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RLdjYRoIuT/UDW/92idTW9f04fbO4WYzD8NpUNfkjsEau0WaRhUQPOBc0RLKhD+g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.738.0/index.min.mjs": "sha384-RLdjYRoIuT/UDW/92idTW9f04fbO4WYzD8NpUNfkjsEau0WaRhUQPOBc0RLKhD+g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.738.0/LICENSE
```

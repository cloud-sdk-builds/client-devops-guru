...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jmvajA74uf+oizWeilmU5bbxhq8atOuKS2w5/+Uov+TlW3xypzZfmnfBJug8AuYf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.896.0/index.min.mjs": "sha384-jmvajA74uf+oizWeilmU5bbxhq8atOuKS2w5/+Uov+TlW3xypzZfmnfBJug8AuYf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.896.0/LICENSE
```

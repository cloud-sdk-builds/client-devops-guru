...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+QEjyEHoEdgjxajjTcNs5Dj/eoIDX2wh0wbz+fbPviE4/OhtnvoyIlgK7DQT/1zt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.55.0/index.min.mjs": "sha384-+QEjyEHoEdgjxajjTcNs5Dj/eoIDX2wh0wbz+fbPviE4/OhtnvoyIlgK7DQT/1zt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.55.0/LICENSE
```

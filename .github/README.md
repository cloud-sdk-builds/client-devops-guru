...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.280.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.280.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xR/P53Nwj4Kzzv19zdFia+0zMWYC2I/fYmbKyqQba3ZxSsGV0eq3cm0X1a/hxKMR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.280.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.280.0/index.min.mjs": "sha384-xR/P53Nwj4Kzzv19zdFia+0zMWYC2I/fYmbKyqQba3ZxSsGV0eq3cm0X1a/hxKMR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.280.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FncmvrguXEbDIMtoqUc2ABwEM148Jxv5wK+WR1kIswY13KZVsDo6xe4BPSnXNXhg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.1025.0/index.min.mjs": "sha384-FncmvrguXEbDIMtoqUc2ABwEM148Jxv5wK+WR1kIswY13KZVsDo6xe4BPSnXNXhg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.1025.0/LICENSE
```

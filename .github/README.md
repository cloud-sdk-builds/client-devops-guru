...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XwhliJpw7uat0Jb+/a57diVRqeqpAUpVqGl9AVF/rDa7w40CwrLg6tqA+vDfetOP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.329.0/index.min.mjs": "sha384-XwhliJpw7uat0Jb+/a57diVRqeqpAUpVqGl9AVF/rDa7w40CwrLg6tqA+vDfetOP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.329.0/LICENSE
```

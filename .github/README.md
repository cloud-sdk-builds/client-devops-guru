...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-622O7+nS0ICv3TrI60dz9iPR1hdPTlEPxKqXQX4czDaXz5gAIJQ6TSmUDGDdx7Og
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.282.0/index.min.mjs": "sha384-622O7+nS0ICv3TrI60dz9iPR1hdPTlEPxKqXQX4czDaXz5gAIJQ6TSmUDGDdx7Og"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.282.0/LICENSE
```

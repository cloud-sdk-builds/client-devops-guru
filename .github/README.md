...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l/HtdF0u78HFOL8CqOyrcHfeAnT7lH9zVuCOPJkXu6WffvHwmdjWOtEeo8hW8s7J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.899.0/index.min.mjs": "sha384-l/HtdF0u78HFOL8CqOyrcHfeAnT7lH9zVuCOPJkXu6WffvHwmdjWOtEeo8hW8s7J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.899.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-8msjD//q3tR7g0NYURaOFmaYoRdFB7dprVR7wit7SDtBL7NmMDzUG3brZ1b0sor0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.47.2/index.min.mjs": "sha384-8msjD//q3tR7g0NYURaOFmaYoRdFB7dprVR7wit7SDtBL7NmMDzUG3brZ1b0sor0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.47.2/LICENSE
```

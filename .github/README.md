...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SMOkfPdeDv5W80JgtK9PzVJthG6zmMGlcZixrguezTjnoL32OPJ3aSEbrNiJwFiw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.14.0/index.min.mjs": "sha384-SMOkfPdeDv5W80JgtK9PzVJthG6zmMGlcZixrguezTjnoL32OPJ3aSEbrNiJwFiw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.14.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CmWwGIdHGdtnN4W0fkLrbYlKOxeuSUqw7Wf/46ahI0iCOLGtOSIdO4ulRG1J8jPG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.226.0/index.min.mjs": "sha384-CmWwGIdHGdtnN4W0fkLrbYlKOxeuSUqw7Wf/46ahI0iCOLGtOSIdO4ulRG1J8jPG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.226.0/LICENSE
```

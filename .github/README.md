...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jfLcpqrS6uYtrFiyXb1/JtA99r8aqp4fpzbSs2b9KwY45T8kvg7+yDWTPEz5SK75
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.22.0/index.min.mjs": "sha384-jfLcpqrS6uYtrFiyXb1/JtA99r8aqp4fpzbSs2b9KwY45T8kvg7+yDWTPEz5SK75"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.22.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B92fb3kAhUvSUhRolDEhWeRtDSy0j1IhV8i38OkxKxOXEFj7ewk1MWIsK4QpTRn8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.726.0/index.min.mjs": "sha384-B92fb3kAhUvSUhRolDEhWeRtDSy0j1IhV8i38OkxKxOXEFj7ewk1MWIsK4QpTRn8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.726.0/LICENSE
```

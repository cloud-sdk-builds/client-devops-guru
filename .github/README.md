...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m7fSAiLYBPNfIS0lPlJEQW5lafFmbarkpePvafPQ3y/iXW7vhezLN2z2ZeJBoDVJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.26.0/index.min.mjs": "sha384-m7fSAiLYBPNfIS0lPlJEQW5lafFmbarkpePvafPQ3y/iXW7vhezLN2z2ZeJBoDVJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.26.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A1WLrsAFEdsI8oUZdwSdYVs8v1j5vZv4QFSEMWdDxCJ355d/SAeBcI+LUzd2PASv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.40.0/index.min.mjs": "sha384-A1WLrsAFEdsI8oUZdwSdYVs8v1j5vZv4QFSEMWdDxCJ355d/SAeBcI+LUzd2PASv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.40.0/LICENSE
```

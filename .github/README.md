...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nhusQN6ItWQj03V+Ro0mJ19n3y79Q2TZE2+M3LNg19rJF0weDCbXHpqFLev4T1Oa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.199.0/index.min.mjs": "sha384-nhusQN6ItWQj03V+Ro0mJ19n3y79Q2TZE2+M3LNg19rJF0weDCbXHpqFLev4T1Oa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.199.0/LICENSE
```

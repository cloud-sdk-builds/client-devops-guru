...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zp22BhA26zob3eyZWwPBKP3BrFmujdzny1hK8DS5IMyVCbJVD6NkkETX7hpkxBvL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.774.0/index.min.mjs": "sha384-zp22BhA26zob3eyZWwPBKP3BrFmujdzny1hK8DS5IMyVCbJVD6NkkETX7hpkxBvL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.774.0/LICENSE
```

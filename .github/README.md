...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N0B/6L+t9+38bJnhrii1y6imsAAkCb3R/Zu0c6FByYjkw5tHMTnMyi18sgjM1A4T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.913.0/index.min.mjs": "sha384-N0B/6L+t9+38bJnhrii1y6imsAAkCb3R/Zu0c6FByYjkw5tHMTnMyi18sgjM1A4T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.913.0/LICENSE
```

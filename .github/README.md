...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xsd73SPUAN9p0zLX46sWqyGepOCWebUKzfEwIfU08Hk31039KSei9898OMZeDTbu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.882.0/index.min.mjs": "sha384-Xsd73SPUAN9p0zLX46sWqyGepOCWebUKzfEwIfU08Hk31039KSei9898OMZeDTbu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.882.0/LICENSE
```

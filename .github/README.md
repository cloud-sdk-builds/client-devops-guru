...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N7Cq1/gyGTwAAzcGlBW8G2cqbEOsr+qiZg7yARA5WYNOP7xokx5ayDHxuGXlTX0f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.823.0/index.min.mjs": "sha384-N7Cq1/gyGTwAAzcGlBW8G2cqbEOsr+qiZg7yARA5WYNOP7xokx5ayDHxuGXlTX0f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.823.0/LICENSE
```

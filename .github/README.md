...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Es7iQ5iYo/0uSlKCYmrLY7e+DbZICsdZ1bZ1R4R6DQtLmxfWF5aubHuec2HcR2AK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.965.0/index.min.mjs": "sha384-Es7iQ5iYo/0uSlKCYmrLY7e+DbZICsdZ1bZ1R4R6DQtLmxfWF5aubHuec2HcR2AK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.965.0/LICENSE
```

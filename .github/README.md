...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TcgORy8L79lBp4BqsboP47i7Ph5jwMB+cQhMRNcQbeVw1F3zsuynQLIO6zhkDWw6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.772.0/index.min.mjs": "sha384-TcgORy8L79lBp4BqsboP47i7Ph5jwMB+cQhMRNcQbeVw1F3zsuynQLIO6zhkDWw6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.772.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lfzQGzz6PHV03nO6snevElI9SZZybtWoyAx5MC2z7NsnJH59t5R7+Rhb4wbRWCLO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.436.0/index.min.mjs": "sha384-lfzQGzz6PHV03nO6snevElI9SZZybtWoyAx5MC2z7NsnJH59t5R7+Rhb4wbRWCLO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.436.0/LICENSE
```

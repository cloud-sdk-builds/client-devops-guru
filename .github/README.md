...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-piw/IV9Iyo6Ts8oc8dCGxprF3ydBXxhFkrHt+IpNGxSJMN+wmPbSBUkylLKKau5R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.886.0/index.min.mjs": "sha384-piw/IV9Iyo6Ts8oc8dCGxprF3ydBXxhFkrHt+IpNGxSJMN+wmPbSBUkylLKKau5R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.886.0/LICENSE
```

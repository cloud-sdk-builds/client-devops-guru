...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YTZwpFTvAJF8ZkW5fsA71yWTVkPwcSGXqTttowZ+AkA2vmg9SvAMBHNggn9Slxfi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.27.0/index.min.mjs": "sha384-YTZwpFTvAJF8ZkW5fsA71yWTVkPwcSGXqTttowZ+AkA2vmg9SvAMBHNggn9Slxfi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.27.0/LICENSE
```

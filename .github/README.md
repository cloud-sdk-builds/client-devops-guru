...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-58PhbKh04FSRQLe9AxMS7q7Gbl9dyr6p4mBh+FtuA+xvb4XZe8i4VPk2OC8LyQxM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.141.0/index.min.mjs": "sha384-58PhbKh04FSRQLe9AxMS7q7Gbl9dyr6p4mBh+FtuA+xvb4XZe8i4VPk2OC8LyQxM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.141.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-om+yBFz5MmlAN8iB4VFbR8NCH9ENxopDoD+wNQp01mzF6ZLVZOwj0wzxaw7DrJUJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.354.0/index.min.mjs": "sha384-om+yBFz5MmlAN8iB4VFbR8NCH9ENxopDoD+wNQp01mzF6ZLVZOwj0wzxaw7DrJUJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.354.0/LICENSE
```

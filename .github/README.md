...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eJ2f95RIISiZe1kgUZLkPgJUIAhZepTIe/Jrs/KCOEB+Tu3mrma1MzllAXYDnYvA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.876.0/index.min.mjs": "sha384-eJ2f95RIISiZe1kgUZLkPgJUIAhZepTIe/Jrs/KCOEB+Tu3mrma1MzllAXYDnYvA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.876.0/LICENSE
```

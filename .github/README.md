...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WF5y9o42zCtxC2mPgwjZfa16MgdBMEIQH6tWwuMhrtCssEJ/fQUKcvR8UABrWjdf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.668.0/index.min.mjs": "sha384-WF5y9o42zCtxC2mPgwjZfa16MgdBMEIQH6tWwuMhrtCssEJ/fQUKcvR8UABrWjdf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.668.0/LICENSE
```

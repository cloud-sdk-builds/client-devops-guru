...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jh9gW1+sWioxYRJSzN2eYlsLwoHym+caQroRKJw3OV7zUUnowLOGwqt8senjizjM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.873.0/index.min.mjs": "sha384-Jh9gW1+sWioxYRJSzN2eYlsLwoHym+caQroRKJw3OV7zUUnowLOGwqt8senjizjM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.873.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AEQwgB9h8MCmFka9CbenrgkJv2M/fX9p84UXzfNVtvv3HlwvVefj9sGClQrEPLEv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.750.0/index.min.mjs": "sha384-AEQwgB9h8MCmFka9CbenrgkJv2M/fX9p84UXzfNVtvv3HlwvVefj9sGClQrEPLEv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.750.0/LICENSE
```

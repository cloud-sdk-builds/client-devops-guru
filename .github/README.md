...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i9N9qDszH6Rf5GmBPIyZGHoJC7dkKutZc7kZp1h3DjEX3N6HmKSaSv2XWLakgXe9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.490.0/index.min.mjs": "sha384-i9N9qDszH6Rf5GmBPIyZGHoJC7dkKutZc7kZp1h3DjEX3N6HmKSaSv2XWLakgXe9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.490.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+3B5ZchtlBvA/ZZvGI5ASCkrGKkQzVl9FD6JCCMidlx6mgbIEmnI9LvldTybd9I1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.955.0/index.min.mjs": "sha384-+3B5ZchtlBvA/ZZvGI5ASCkrGKkQzVl9FD6JCCMidlx6mgbIEmnI9LvldTybd9I1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.955.0/LICENSE
```

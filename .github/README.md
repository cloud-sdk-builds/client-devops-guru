...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3EoTSpKADOHHGQU+8+otB+t+nxB3+aaSLMlSo1BxF2134kKKOAfnQfQDa5xwg1cV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.405.0/index.min.mjs": "sha384-3EoTSpKADOHHGQU+8+otB+t+nxB3+aaSLMlSo1BxF2134kKKOAfnQfQDa5xwg1cV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.405.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-796I4qWHkImXDPQtjMe0Bx7MHjUjSeDaFBu7O1TdHOvOdAwT15RO7ibZ/ON5fJF4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.202.0/index.min.mjs": "sha384-796I4qWHkImXDPQtjMe0Bx7MHjUjSeDaFBu7O1TdHOvOdAwT15RO7ibZ/ON5fJF4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.202.0/LICENSE
```

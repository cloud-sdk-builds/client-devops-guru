...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i4U+sN2B5CvLM2gRMgZNIEKufDRI6k7avTIoqOXt4DYH9huSlrIMTXOf5Oicno7Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.413.0/index.min.mjs": "sha384-i4U+sN2B5CvLM2gRMgZNIEKufDRI6k7avTIoqOXt4DYH9huSlrIMTXOf5Oicno7Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.413.0/LICENSE
```

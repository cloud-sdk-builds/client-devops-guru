...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZYV4cnYTLoV9Li8zgnVGk1OQlc49F62VuPGFo51fYtpwlviVuybNSuXIvfiwlno9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.658.1/index.min.mjs": "sha384-ZYV4cnYTLoV9Li8zgnVGk1OQlc49F62VuPGFo51fYtpwlviVuybNSuXIvfiwlno9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.658.1/LICENSE
```

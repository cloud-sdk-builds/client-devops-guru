...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KJqKwI3ELxXLw85C5/cegi7PWjBvB1MGsTNasPt+YJp4AfTeVjiSN1vXx1ylzsuI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.540.0/index.min.mjs": "sha384-KJqKwI3ELxXLw85C5/cegi7PWjBvB1MGsTNasPt+YJp4AfTeVjiSN1vXx1ylzsuI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.540.0/LICENSE
```

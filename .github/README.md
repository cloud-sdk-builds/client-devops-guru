...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AdSOAyvN0HyUtUHM1sw1keSXGaA9YwpI2zda3HWzwrP5Kul1x0yvboDJGHxV/9ws
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.409.0/index.min.mjs": "sha384-AdSOAyvN0HyUtUHM1sw1keSXGaA9YwpI2zda3HWzwrP5Kul1x0yvboDJGHxV/9ws"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.409.0/LICENSE
```

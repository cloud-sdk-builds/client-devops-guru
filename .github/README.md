...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z2ydlmO709SACBuL0LsjNVCrfBKOPwNbG8l2TOLTSGblmRYfAe/7NGbu5UXcjFzd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.600.0/index.min.mjs": "sha384-Z2ydlmO709SACBuL0LsjNVCrfBKOPwNbG8l2TOLTSGblmRYfAe/7NGbu5UXcjFzd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.600.0/LICENSE
```

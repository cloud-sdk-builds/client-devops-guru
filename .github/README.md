...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qqjozvrIuWrMV8+iKmnsozOHB80Pdn4kQvegqkhLYqwjS9hgAjOh3HEvXzB/LF4N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.337.0/index.min.mjs": "sha384-qqjozvrIuWrMV8+iKmnsozOHB80Pdn4kQvegqkhLYqwjS9hgAjOh3HEvXzB/LF4N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.337.0/LICENSE
```

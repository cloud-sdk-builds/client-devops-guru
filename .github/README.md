...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mbi6b1lyB7uUHPMPvsnUlFwjqaf1rWetf9ukthpm3qT2ulVEMtxmOieMImB80kOR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.775.0/index.min.mjs": "sha384-Mbi6b1lyB7uUHPMPvsnUlFwjqaf1rWetf9ukthpm3qT2ulVEMtxmOieMImB80kOR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.775.0/LICENSE
```

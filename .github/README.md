...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aVVnxFrqtaNp5gK0dFHXphp+uPSvbtIrn7ViKdTpL5x7opQdG+Qhn2n8cYWy/jsc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.213.0/index.min.mjs": "sha384-aVVnxFrqtaNp5gK0dFHXphp+uPSvbtIrn7ViKdTpL5x7opQdG+Qhn2n8cYWy/jsc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.213.0/LICENSE
```

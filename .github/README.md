...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NLhp4PK1TSkFxGfsAT2Ecgb0hj+Qsbi7YE09j2wJg5+BoMRsh0pgv0NHMpujPL2v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.925.0/index.min.mjs": "sha384-NLhp4PK1TSkFxGfsAT2Ecgb0hj+Qsbi7YE09j2wJg5+BoMRsh0pgv0NHMpujPL2v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.925.0/LICENSE
```

...
[`@aws-sdk/client-devops-guru`](https://www.npmjs.com/package/@aws-sdk/client-devops-guru/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u3asL76chu5A+CgAxwGDYYEjBJy+8mC1M5vN6GGMp676zJlOROgpAYSJ9N56wXmO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-devops-guru": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-devops-guru@3.18.0/index.min.mjs": "sha384-u3asL76chu5A+CgAxwGDYYEjBJy+8mC1M5vN6GGMp676zJlOROgpAYSJ9N56wXmO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-devops-guru/blob/refs/tags/3.18.0/LICENSE
```
